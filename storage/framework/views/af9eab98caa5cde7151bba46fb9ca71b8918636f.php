                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo e(url('/operaciones/reporte')); ?>">Reporte general de operaciones</a></li>
                                ...
                                <!--<li><a href="<?php echo e(url('prepago/supervisor/perRefRep')); ?>">Referencias repetidas</a></li>-->
                                <!-- <li><a href="<?php echo e(url('/reporteRV')); ?>">Reporte de ventas completo</a></li> -->

                                <!--<li><a href="<?php echo e(url('/subirVentas')); ?>">Subir ventas</a></li>
                                <li><a href="<?php echo e(url('/subirVentasRechazadas')); ?>">Subir ventas rechazadas</a></li>
                                <li><a href="<?php echo e(url('/ventasRechazadas')); ?>">Lista ventas a editar</a></li>
                                <li><a href="<?php echo e(url('/inicioDescargaVentasRechazadas')); ?>">Descargar ventas editadas</a></li>-->
                                <li><a href="<?php echo e(url('/EdicionAva')); ?>">Edicion por avance</a></li>
                                <li><a href="<?php echo e(url('/EdicionEsta')); ?>">Edicion por Estatus</a></li>
			                     <li><a href="<?php echo e(url('/EdicionEdi')); ?>">Edicion por editor</a></li>
                                <li><a href="<?php echo e(url('/asistenciaHistorico')); ?>">Reporte Historico Asistencias</a></li>
                        ...
                        <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(url('/calidad/inbursa')); ?>">Nuevo rango de fechas</a></li>
                                    <li><a href="<?php echo e(url('/calidad/inbursaVidatel')); ?>">Nuevo rango de fechas Vidatel</a></li>
                                    <li><a href="<?php echo e(url('/platillaAsistencia')); ?>">Reporte de asistencias</a></li>
