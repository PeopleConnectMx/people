                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-page-length='100'>
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                      <td class="center" style="text-align: center;"><a href="{{ url('facebook/updateventa/'.$datosValues->id) }}">{{$datosValues->id}}</a></td>
                                        ...
                                        <td style="text-align: center;">{{ $datosValues->sipdv }}</td>
