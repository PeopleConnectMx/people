...
<div class="container-fluid">
  ...
  <div class="col-md-8 col-md-offset-2">
    ...
    {{ Form::open(['action' => 'ConalitegController@Save',
                    'method' => 'post',
  ...
  <fieldset>
    <legend>
      <h3>Encuesta telefónica</h3>
  </legend>
    <div class="form-group">
      <!-- <label for="" class="col-lg-2 control-label"><span class="label label-warning" id="getAjax">Warning</span></label> -->
      <label for="" class="col-lg-2 control-label"><a id="getAjax" class="btn btn-danger">Datos</a></label>

      <div class="col-lg-2">
        <input type="text" class="form-control" id="d1" name="d1" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div>

      <!-- <div class="col-lg-2">
        <input type="text" class="form-control" id="d2" name="d2" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div> -->

      <div class="col-lg-2">
        <input type="text" class="form-control" id="d3" name="d3" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div>

      <div class="col-lg-2">
        <input type="text" class="form-control" id="d4" name="d4" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-2">
        <input type="text" class="form-control" id="d5" name="d5" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div>

      <div class="col-lg-2">
        <input type="text" class="form-control" id="d6" name="d6" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div>

      <div class="col-lg-2">
        <input type="text" class="form-control" id="d7" name="d7" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div>

      <div class="col-lg-2">
        <input type="text" class="form-control" id="d8" name="d8" value="" required="" {{ ($descanso) ? 'disabled=""' : '' }}  readonly >
      </div>
    </div>
...
function sub() {
  ...
  if(st=='INCIDENCIA'){
      ...
      "<option value='USUARIO CORTO COMUNICACIÓN'>USUARIO CORTO COMUNICACIÓN</option>"+
