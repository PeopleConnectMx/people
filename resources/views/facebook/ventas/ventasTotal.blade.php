    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
               ...
               {{ Form::open(['action' => 'FaceBookVentasController@UpdateDatosValidaTotal',
                              'method' => 'post',
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      {{ Form::text('nip',$datos[0]->nip,array('class'=>"form-control", 'placeholder'=>"",'onChange'=>'validacion(this.value)','id'=>'telefono','maxlength'=>'4')) }}
                  </div>
              </div>
              <div class="form-group">
                  {{ Form::label('CURP','',array('class'=>"col-sm-2 control-label")) }}
                  <div class="col-sm-10">
                      {{ Form::text('curp',$datos[0]->curp,array('class'=>"form-control", 'placeholder'=>"",'onChange'=>'validacion(this.value)','id'=>'telefono','maxlength'=>'19')) }}
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      ...
                      'Ok' => 'Ok',
                      'No ok' => 'No ok'],
                  $datos[0]->estatus, ['required' => 'required', 'class'=>"form-control", 'placeholder'=>""]  ) }}
                  </div>
              </div>
              <div class="form-group">
                  {{ Form::label('Referencia 1','',array('class'=>"col-sm-2 control-label")) }}
                  <div class="col-sm-10">
                      {{ Form::text('ref_1',$datos[0]->ref1,array('class'=>"form-control", 'placeholder'=>"",'id'=>'paterno')) }}
                  </div>
              </div>
              <div class="form-group">
                  {{ Form::label('Referencia 2','',array('class'=>"col-sm-2 control-label")) }}
                  <div class="col-sm-10">
                      {{ Form::text('ref_2',$datos[0]->ref2,array('class'=>"form-control", 'placeholder'=>"",'id'=>'materno')) }}
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      {{ Form::date('fecha',$datos[0]->fecha,array('class'=>"form-control", 'placeholder'=>"",'id'=>'nombre')) }}
                  </div>
              </div>
              <div class="form-group">
