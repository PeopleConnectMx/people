    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Reportes de Bajas</h3>
            </div>
            <div class="panel-body">

                {{ Form::open(['action' => 'ReportesController@ReporteBaja',
                                'method' => 'post',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::select('tipo', [
                        'baja1'=>'Reporte de baja 1',
                        'baja2'=>'Reporte de baja 2',
                        'baja3'=>'Reporte de baja 3',
                        'baja4'=>'Reporte de baja 4',
                        'baja5'=>'Reporte de baja 5'
                        ],
