          ...
          <div class="row">
            <h3 class="col-lg-2">
              ...
              <select class="form-control" id="select" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                <option value="{{URL('/direccion/proyeccion/pospago')}}/{{date('Y-m-d')}}"></option>
                @foreach($rfechas as $value)
                <option value="{{URL('/direccion/proyeccion/pospago')}}/{{$value->a}}-{{$value->m}}-{{date('d')}}">{{$value->a}}-{{$value->m}}</option>
                @endforeach
              </select>
                ...
                <tr class="success">
                  ...
                  <tr class="success">
                    ...
                    {{--*/
                      ...
                      {{--*/ $altasm= array_key_exists($date, $altas_prepago_m) ? $altas_prepago_m[$date] : 0 /*--}}
                      {{--*/ $num_altasm= array_key_exists($date, $num_altas_prepago_m) ? $num_altas_prepago_m[$date] : 0 /*--}}
                      {{--*/ $color='black'; $calc=0;
                      if($dias!=0){
                        $calc= round(($altasm/$dias)*100 ,0);
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="number" id="tmprealtm{{$date}}" onchange="tmprealtgen(this.id)" value="{{$dias}}"  style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtm{{$date}}2" >
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $num_altasm}} </span>
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $altasm}}% </span>
                        </div>
                      </td>
                      {{--*/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /*--}}
                    ...
                    <td>
                        <div>
                          <span> {{ round($tot1/$contador,2) }} %</span><br>
                          <span class="badge" style="background-color:{{$color}};">{{ $tot3 }} </span>
                          <span class="badge" style="background-color:{{$color}};">{{ round($tot2/$contador,2) }}% </span>
                        </div>
                    </td>
                  </tr>
                  ...
                  <tr class="success">
                    ...
                    {{--*/
                        $dias=40;
                      /*--}}
                      {{--*/ $altasv= array_key_exists($date, $altas_prepago_v) ? $altas_prepago_v[$date] : 0 /*--}}
                      {{--*/ $num_altasv= array_key_exists($date, $num_altas_prepago_v) ? $num_altas_prepago_v[$date] : 0 /*--}}
                      {{--*/ $color='black'; $calc=0;
                      if($dias!=0){
                        $calc= round(($altasv/$dias)*100 ,0);
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="number" id="tmprealtv{{$date}}" value="{{$dias}}"  onchange="tmprealtgen(this.id)" style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtv{{$date}}2" >
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $num_altasv}}</span>
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $altasv}}% </span>
                        </div>
                      </td>
                      {{--*/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /*--}}
                  ...
                  <tr class="success">
                    ...
                    {{--*/
                      ...
                      {{--*/ $num_altasm_pos= array_key_exists($date, $num_altas_pospago_m) ? $num_altas_pospago_m[$date] : 0 /*--}}
                      {{--*/ $num_altasv_pos= array_key_exists($date, $num_altas_pospago_v) ? $num_altas_pospago_v[$date] : 0 /*--}}

                      {{--*/ $altas_totales= $num_altasm + $num_altasv + $num_altasm_pos + $num_altasv_pos /*--}}
                      {{--*/ $altas_totales_pre= $num_altasm + $num_altasv /*--}}
                      {{--*/ $altas_totales_pos= $num_altasm_pos + $num_altasv_pos /*--}}
                      {{--*/
                        $altas_totales != 0 ?
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="text" id="tmprealtg{{$date}}" value="{{$dias}}"  style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtg{{$date}}2" >
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $num_altasm + $num_altasv }} </span>
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $altas_prepago_calc }}% </span>
                        </div>
                      </td>
                      {{--*/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /*--}}
                    @endwhile
                    ...
                    <td>
                        <div>
                          <span> {{ round($tot1/$contador,2) }} %</span><br>
                          <span class="badge" style="background-color:{{$color}};">{{ $tot3 }} </span>
                          <span class="badge" style="background-color:{{$color}};">{{ $tot4 !=0 ? round(($tot3/$tot4)*100,2) : 0 }}% </span>
                        </div>
                    </td>
                  </tr>
                  ...
                  <tr class="warning">
                    ...
                    {{--*/
                      ...
                      {{--*/ $altasm= array_key_exists($date, $altas_pospago_m) ? $altas_pospago_m[$date] : 0 /*--}}
                      {{--*/ $num_altasm= array_key_exists($date, $num_altas_pospago_m) ? $num_altas_pospago_m[$date] : 0 /*--}}
                      {{--*/ $color='black'; $calc=0;
                      if($dias!=0){
                        $calc= round(($altasm/$dias)*100 ,0);
                  ...
                  <tr class="warning">
                    ...
                    {{--*/
                        $dias=60;
                      /*--}}
                      {{--*/ $altasv= array_key_exists($date, $altas_pospago_v) ? $altas_pospago_v[$date] : 0 /*--}}
                      {{--*/ $num_altasv= array_key_exists($date, $num_altas_pospago_v) ? $num_altas_pospago_v[$date] : 0 /*--}}
                  ...
                  <tr class="warning">
                    ...
                    {{--*/
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="text" id="tmprealtg{{$date}}" value="{{$dias}}"  style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtg{{$date}}2" >
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $num_altasm_pos+ $num_altasv_pos }} </span>
                          <span class="badge" style="margin-left: -20%;background-color:{{$color}};">{{ $altas_pospago_calc }}% </span>
                        </div>
                      </td>
                      {{--*/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /*--}}
                    @endwhile
