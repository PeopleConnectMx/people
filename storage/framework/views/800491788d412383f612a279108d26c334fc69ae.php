        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::select('area', $area,
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::select('campaign', $camp,
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Correo Administrativo','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('correoI',$DetalleEmpleado[0]->correo_administrativo,array('class'=>"form-control"))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Forma de pago','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::select('forma_pago', [
                        'Efectivo' => 'Efectivo',
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Tipo de cuenta','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::select('tipo_cuenta', [
                        'Tarjeta' => 'Tarjeta',
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Número de cuenta/tarjeta','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('num_cuenta',$DetalleEmpleado[0]->num_cuenta,array('class'=>"form-control"))); ?>
