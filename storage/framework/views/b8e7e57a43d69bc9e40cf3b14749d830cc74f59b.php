            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Administración Root</a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                          <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                <?php /**/ $fechap= date('Y-m-d')/**/ ?>
                                  <li><a href="<?php echo e(url('/direccion/proyeccion/prepago/')); ?><?php echo e('/'.date('Y-m-d')); ?>">TM Prepago</a></li>
                                  <li><a href="<?php echo e(url('/direccion/proyeccion/pospago/').date('/Y-m-d')); ?>">TM Pospago</a></li>
                                  <li><a href="<?php echo e(url('/direccion/proyeccion/inbursa/')); ?><?php echo e('/'.date('Y-m-d')); ?>">Inbursa</a></li>
								                  <li><a href="<?php echo e(url('/direccion/proyeccion/banamex')); ?>">Banamex</a></li>
                              </ul>
                          </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?php echo e(url('/Administracion/admin/repventas3Movi')); ?>">Reporte de ventas TM Prepago por Franja Horaria</a></li>
                                    <li><a href="<?php echo e(url('/Administracion/admin/PosicionesMovi')); ?>">Reporte de posiciones TM Prepago</a></li>
                                    ...
                                    <li><a href="<?php echo e(url('/Administracion/admin/perRefRep')); ?>">Referencias repetidas</a></li>
                                    <li><a href="<?php echo e(url('/Administracion/admin/perMonitoreoAC')); ?>">Reporte de calidad</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(url('/Administracion/admin/perMarInbursa')); ?>">Reporte de marcación inbursa</a></li>
                                    <li><a href="<?php echo e(url('/reporteMarcacionEstado')); ?>">Reporte general de marcacion Inbursa</a></li>
                                    <li><a href="<?php echo e(url('/Administracion/admin/PosicionesInbursa')); ?>">Reporte de posiciones Inbursa</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                    ...
                                    <li><a href="<?php echo e(url('/Administracion/admin/plantillaV2')); ?>">Plantilla version minimizada</a></li>
                                    <li><a href="<?php echo e(url('/Administracion/personal')); ?>">Personal</a></li>
                                    <li><a href="<?php echo e(url('/Administracion/admin/PendienteAlta')); ?>">Pendiente de Alta</a></li>
