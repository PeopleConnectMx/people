    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              {{ Form::open(['action' => 'BancomerController@Guarda',
                              'method' => 'post',
                ...
                <div id="exist"  style="display:none" > <!-- si encuentra dn -->
                  <div class="form-group">
                      ...
                      {{ Form::label('Numero de Cliente','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-3">
                          {{ Form::text('n_cliente','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'n_cliente')) }}
                      </div>
                      {{ Form::label('ITEM identificador','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-3">
                          {{ Form::text('item_identificador','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'item_identificador')) }}
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      {{ Form::label('Municipio','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-5">
                          {{ Form::text('municipio','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'municipio')) }}
                      </div>
                  </div>
                  <div class="form-group">
                      {{ Form::label('Producto','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-5">
                          {{ Form::text('producto','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'producto','readonly'=>'readonly')) }}
                      </div>
                      {{ Form::label('Categoria','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-5">
                          {{ Form::text('categoria','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'categoria','readonly'=>'readonly')) }}
                      </div>
                  </div>
                  <div class="form-group">
                      {{ Form::label('Segmento','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-5">
                          {{ Form::text('segmento','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'segmento','readonly'=>'readonly')) }}
                      </div>
                      {{ Form::label('Mora','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-5">
                          {{ Form::text('mora','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'mora','readonly'=>'readonly')) }}
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      {{ Form::label('Telefono 4','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-2">
                          {{ Form::text('tel4','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'tel4','onClick'=>'num4()')) }}
                      </div>
                  </div>
                  <div class="form-group">
                      {{ Form::label('Telefono 5','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-2">
                          {{ Form::text('tel5','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'tel5','onClick'=>'num5()')) }}
                      </div>
                      {{ Form::label('Telefono 6','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-2">
                          {{ Form::text('tel6','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'tel6','onClick'=>'num6()')) }}
                      </div>
                      {{ Form::label('Telefono 7','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-2">
                          {{ Form::text('tel7','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'tel7','onClick'=>'num7()')) }}
                      </div>
                      {{ Form::label('Telefono 8','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-2">
                          {{ Form::text('tel8','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'tel8','onClick'=>'num8()')) }}
                      </div>
                  </div>
                  <div class="form-group">
                      {{ Form::label('Telefono 9','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-2">
                          {{ Form::text('tel9','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'tel9','onClick'=>'num9()')) }}
                      </div>
                      {{ Form::label('Telefono 10','',array('class'=>"col-sm-1 control-label")) }}
                      <div class="col-sm-2">
                          {{ Form::text('tel10','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'tel10','onClick'=>'num10()')) }}
                      </div>
