            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Calidad | TM Pospago</a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(url('/calidad/pospago')); ?>">Nuevo rango de fechas</a></li>
                                    <li><a href="<?php echo e(url('/calidad/pospago/novalidado')); ?>">No Validado</a></li>
