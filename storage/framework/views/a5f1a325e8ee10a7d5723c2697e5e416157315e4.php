                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?php echo e(url('/direccion/proyeccion/inbursa/').date('/Y-m-d')); ?>"> Inbursa </a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?php echo e(url('/Administracion/asistenciaHistorico')); ?>">Reporte Historico Asistencias</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(url('reportesVentasFB')); ?>">Reporte Ventas FB</a></li>
                                    <li><a href="<?php echo e(url('reportesOperadorVentasFB')); ?>">Reporte por Operador Ventas FB</a></li>
