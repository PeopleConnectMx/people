    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Reporte de Blaster 4</h3>
            </div>
            <div class="panel-body">

                {{ Form::open(['action' => 'ReportesController@BlasterThree',
                                'method' => 'post',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::select('tipo', [
                        'tipo1'=>'Reporte de Blaster tipo 1',
                        'tipo2'=>'Reporte de Blaster tipo 2'],
