    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php echo e(Form::open(['action' => 'VivaAnunciosController@VentasDia',
                                'method' => 'post',
...
<?php echo $__env->make('layout.VivaAnuncios.vivaSupervisor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>