        ...
        <header>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">PeopleConnect Gerente</a>
                </div>

                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                      <!-- <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Nomina<span class="caret"></span></a>
                          <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('Nomina/nomina/web') }}">General</a></li>
...
<!--                            <li><a href="{{ url('/reporteMarcacionEstado') }}">Reporte de Marcacion general</a></li>
                            ...
                            <li><a href="/reporteMarcacionEstado">Reporte general de marcacion Inbursa</a></li>
...
<!--                            <li><a href="/reporteMarcacionContactacionDiaMapfre">Marcacion contactacion por dia Mapfre</a></li>
                            ...
                            <li><a href="/inbursa">Reporte de Inbursa</a></li>
