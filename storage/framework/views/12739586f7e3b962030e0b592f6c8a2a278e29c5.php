            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><?php echo e($nombre); ?></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="<?php echo e(url('/auri/graficaLlamada')); ?>" class="btn btn-link" title="Grafica Llamadas" >
                                    <span class="glyphicon glyphicon-signal" aria-hidden="true"></span>
                                </a>
                            </li>
                            <li><a href="<?php echo e(url('/auri/reporteLlamada')); ?>" class="btn btn-link" title="Reporte Llamadas" >
                                    <span class="glyphicon glyphicon-file" aria-hidden="true"></span>
                                </a>
                            </li>
                            <li><a href="<?php echo e(url('/auri/agente')); ?>" class="btn btn-link" title="Llamar" >
                                    <span class="glyphicon glyphicon-phone-alt" aria-hidden="true"></span>
                                </a>
                            </li>
                            <li><a href="<?php echo e(url('/auri/agenda')); ?>" class="btn btn-link" title="Agenda" >
                                    <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                                </a>
                            </li>
                            <li><a href="<?php echo e(url('salir')); ?>" class="btn btn-link" title="Cerrar sesión" >
