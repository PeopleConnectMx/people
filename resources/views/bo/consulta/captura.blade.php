                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          {{ Form::open(['action' => 'BoController@GuardaDatos',
                                          'method' => 'post',
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-9" style="display: none">
                                  {{ Form::text('nombre_val','0',array('id'=>'nombreVal','required' => 'required', 'class'=>"form-control",
                                  'placeholder'=>"", 'readonly'=>'')) }}
                              </div>
                              <div class="col-sm-1">
                                  {{ Form::button('',['class'=>"btn btn-primary glyphicon glyphicon-pencil", "onClick"=>"nombreFuncion()"]) }}
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-9" style="display: none">
                                  {{ Form::text('curp_val','0',array('id'=>'curpVal','required' => 'required', 'class'=>"form-control",
                                  'placeholder'=>"", 'readonly'=>'')) }}
                              </div>
                              <div class="col-sm-1">
                                  {{ Form::button('',['class'=>"btn btn-primary glyphicon glyphicon-pencil", "onClick"=>"curpFuncion()"]) }}
                              </div>
                          </div>
                          <div class="form-group">
