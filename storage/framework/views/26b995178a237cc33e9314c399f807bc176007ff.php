    ...
    <div class="col-lg-8 col-lg-offset-2">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php echo e(Form::open(['action' => 'CalidadController@recluta',
                                        'method' => 'post',
                            ...
                            <thead>
                                <tr>
                                    <div class="form-group">
                                        <?php echo e(Form::label('Reclutador','',array('class'=>"col-sm-2 control-label"))); ?>

                                        <div class="col-sm-10">
                                            <?php echo e(Form::select('Reclutador', $reclutador, null, [ 'class'=>"form-control", 'placeholder'=>"",'required'=>'required','id'=>'reclu']  )); ?>
                                ...
                                <tr>
                                    <div class="form-group">
                                        <?php echo e(Form::label('Fecha de Auditoria','',array('class'=>"col-sm-2 control-label"))); ?>

                                        <div class="col-sm-10">
                                            <?php echo e(Form::date('fecha_auditoria',null,array('class'=>"form-control",'required'=>'required', 'placeholder'=>"********"))); ?>
                                ...
                                <tr>
                                    <div class="form-group">
                                        <?php echo e(Form::label('Fecha de la llamada','',array('class'=>"col-sm-2 control-label"))); ?>

                                        <div class="col-sm-10">
                                            <?php echo e(Form::date('fecha_llamada',null,array('class'=>"form-control",'required'=>'required', 'placeholder'=>"********"))); ?>
                                ...
                                <tr>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('textDn','' ,array('class'=>'form-control', 'placeholder'=>'',"id"=>"textDn"))); ?>
