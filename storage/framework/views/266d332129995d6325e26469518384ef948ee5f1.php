    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php echo e(Form::open(['action' => 'RechazosController@Captura',
                                'method' => 'post',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <?php echo e(Form::text('nip',null,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>""))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::textarea('comentarios','',array('required' => 'required','class'=>"form-control", 'placeholder'=>""))); ?>
