              ...
              <table class="table ">
                ...
                <tr class="success">
                  ...
                  <tr class="danger">
                    ...
                    <td> {{ $tot }}
                      ...
                      <div id="tmpreposm{{$date}}2" >
                        ...
                        <span class="badge" style="background-color:{{$color2}};">{{ $tot !=0 ? round(($cont_pos_mat / $tot) *100 , 2) : 0  }} %</span>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr class="danger">
                    ...
                    <td> {{ $tot }}
                      ...
                      {{--*/
                        ...
                        <div id="tmpreposm{{$date}}2" >
                            <span class="badge" style="background-color:{{$color1}};">{{ $tot5 }}</span><br>
                            <span class="badge" style="background-color:{{$color2}};">{{ $tot != 0 ? round(($tot5/$tot) *100 ,2 ) : 0}} %</span>
                        </div>
                    </td>
                  </tr>
                    ...
                    @while (strtotime($date) <= strtotime($end_date))
                    {{--*/ $recuperado= round(array_key_exists($date, $rechazos_mat) ? $rechazos_mat[$date] : 0,2) /*--}}
                    {{--*/ $recuperado_pronostico= array_key_exists($date, $tmprerecum) ? $tmprerecum[$date] : 0 /*--}}
                    {{--*/ $vr= array_key_exists($date, $vmr) ? $vmr[$date] : 0 /*--}}

                    {{--*/ $totalAprobada= array_key_exists($date, $total_aproba) ? $total_aproba[$date] : 0 /*--}}
                    ...
                    /*--}}
                      <td style="text-align: center;">
                        ...
                        <div id="tmprevenm{{$date}}2" >
                          <span class="badge" style="background-color:{{$color}};">{{ $totalAprobada }} </span>
                          <span class="badge" style="background-color:{{$color}};">{{ round($recuperado,2) }} %</span>
                        </div>
                      </td>
                      {{--*/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /*--}}
                    @endwhile
                    <td>
                        <div>
                          <span> {{ round($tot1/$contador,2) }} %</span><br>
                          <span class="badge" style="background-color:{{$color}};">{{ $tot4 }} </span>
                          <span class="badge" style="background-color:{{$color}};">{{ $tot5 != 0 ? round(($tot4/$tot5) * 100 ,2) : 0 }} % </span>
                        </div>
                    </td>
                  </tr>
                  ...
                  <tr class="danger">
                    ...
                    {{--*/ $recuperado= round(array_key_exists($date, $rechazos_ves) ? $rechazos_ves[$date] : 0,2) /*--}}

                    {{--*/ $recuperado_pronostico= array_key_exists($date, $tmprerecuv) ? $tmprerecuv[$date] : 0 /*--}}

                    {{--*/ $totalAprobav= array_key_exists($date, $total_aprobav) ? $total_aprobav[$date] : 0 /*--}}
                    {{--*/ $vr= array_key_exists($date, $vvr) ? $vvr[$date] : 0 /*--}}
                    ...
                    /*--}}
                      <td style="text-align: center;">
                        ...
                        <div id="tmprevenm{{$date}}2" >
                          <span class="badge" style="background-color:{{$color}};">{{ $totalAprobav }}  </span>
                    ...
                    <td>
                        <div>
                          <span> {{ round($tot1/$contador,2) }} %</span><br>
                          <span class="badge" style="background-color:{{$color}};">{{ $tot4 }} </span>
                          <span class="badge" style="background-color:{{$color}};">{{ round(($tot4/$tot5) *100 ,2) }} %</span>
                        </div>
                    </td>
                  </tr>
                  ...
                  <tr class="danger">
                    ...
                    {{--*/ $aprobadas= array_key_exists($date, $bnmxaprobada) ? $bnmxaprobada[$date] : 0 /*--}}

                    {{--*/ $totalAprobada= array_key_exists($date, $total_aproba) ? $total_aproba[$date] : 0 /*--}}
                    {{--*/ $totalAprobav= array_key_exists($date, $total_aprobav) ? $total_aprobav[$date] : 0 /*--}}

                    {{--*/ $vr_mat= array_key_exists($date, $vmr) ? $vmr[$date] : 0 /*--}}
                    {{--*/ $vr_ves= array_key_exists($date, $vvr) ? $vvr[$date] : 0 /*--}}
                    ...
                    /*--}}
                      ...
                      <td style="text-align: center;">
                        ...
                        value="{{$rechazosp}}" style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%

                        <div id="tmprerecug{{$date}}2" >
                          <span class="badge" style="background-color:{{$color}};"> {{ $totalAprobada + $totalAprobav }} </span><br>
                          <span class="badge" style="background-color:{{$color}};"> {{ $aprobadas }} </span>
                        </div>
                      </td>
                      {{--*/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /*--}}
                    @endwhile
                    <td>
                        <div>
                          <span> {{ round($tot2/$contador,2) }} %</span><br>
                          <span class="badge" style="background-color:{{$color}};">{{ $tot4 }}  </span>
                          <span class="badge" style="background-color:{{$color}};">{{ round(($tot4/$tot5) *100 ,2) }} %</span>
                        </div>
                    </td>
