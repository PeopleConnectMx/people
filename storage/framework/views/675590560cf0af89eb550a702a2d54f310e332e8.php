                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo e(url('/Bancomer_3/reportes')); ?>">Reportes Bancomer 3</a></li>
                                <li><a href="<?php echo e(url('/Bancomer_3/asistencia')); ?>">Asistencias Bancomer 3</a></li>
                                <li><a href="<?php echo e(url('/Bancomer_3/avance')); ?>">Reporte de avance</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
