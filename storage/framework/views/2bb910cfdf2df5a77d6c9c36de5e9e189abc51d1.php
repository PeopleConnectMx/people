              ...
              <table class="table ">
                ...
                <tr class="success">
                  ...
                  <tr class="danger">
                    ...
                    <?php /**/ $total_aprobada = array_key_exists($date, $bnmxtotalprobada) ? $bnmxtotalprobada[$date] : 0 /**/ ?>
                    ...
                    /**/ ?>
                      ...
                      <td style="text-align: center;">
                        ...
                        <div id="tmprerecug<?php echo e($date); ?>2" >
                          <span class="badge" style="background-color:<?php echo e($color); ?>;"> <?php echo e($total_aprobada); ?> </span><br>
                    ...
                    <td>
                        <div>
                          ...
                          <span class="badge" style="background-color:<?php echo e($color); ?>;"><?php echo e(round($tot1/$contador,2)); ?> %</span>
                        </div>
                    </td>
                  </tr>
