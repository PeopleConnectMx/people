@extends('layout.VivaAnuncios.viva')
@section('content')
<?php
$hora = date('H:i:s');
?>
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                {{ Form::open(['action' => 'VivaAnunciosController@guardaFormulario',
                              'method' => 'post',
                ...
                <div id='contenido'>
                    ...
                    <div class="form-group">
                        {{ Form::label('Pregunta 1  ¿Tiene coche?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        {{ Form::label(' Pregunta 2 ¿Piensa vender?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        {{ Form::label('Pregunta 3 ¿Piensa Comprar?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::select('piensa_comprar', [
                                        'NO' => 'NO',
                                        'SI' => 'SI'],
                    ...
                    <div class="form-group">
                        {{ Form::label('Pregunta 4 ¿Nuevo / Seminuevo?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::select('nuevo_seminuevo', [
                                        'NUEVO' => 'NUEVO',
                                        'SEMINUEVO' => 'SEMINUEVO'],
                    ...
                    <div class="form-group">
                        {{ Form::label('Pregunta 5 ¿Cuando Compraría?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        {{ Form::label('Pregunta 6  ¿Presupuesto?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        {{ Form::label('¿Concesionario?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::select('concesionario', [
                                        'NO' => 'NO',
                                        'SI' => 'SI'],
                    ...
                    <div class="form-group">
                        {{ Form::label('Ciudad/Estado','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        {{ Form::label('Nombre Concesionaria','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::text('concesionaria','',array('class'=>"form-control",'id'=>'numero')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        {{ Form::label('¿Modelo a manejar?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::select('modelo', [
                                        'L200' => 'L200',
                                        'OULANDER' => 'OULANDER',
                    ...
                    <div class="form-group">
                        {{ Form::label('Dia Prueba','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::date('dia_prueba','',array('class'=>"form-control",'id'=>'dia_prueba')) }}
                        </div>
                    </div>
                    
                    <div class="form-group">
                        {{ Form::label('Hora prueba','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::time('hora_prueba','',array('class'=>"form-control", 'placeholder'=>"", 'id'=>'hora_prueba')) }}
                        </div>
                    </div>
                    
                    
                    <div class="form-group" style="display: none">
                        {{ Form::label('Hora contacto','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::time('hora_contacto',$hora,array('class'=>"form-control", 'placeholder'=>"", 'id'=>'hora_contacto')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="display: none">
                        {{ Form::label('producto','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
...
<script>
    function datosVivaAnuncios() {
        ...
        window.open("VivaAnuncios/datosWibe", "datosEmpresa", "width=600,height=800, top=100,left=100");
        return false;
