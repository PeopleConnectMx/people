                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-page-length='100'>
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                      <td class="center" style="text-align: center;"><a href="<?php echo e(url('facebook/updateventa/'.$datosValues->id)); ?>"><?php echo e($datosValues->id); ?></a></td>
                                        ...
                                        <td style="text-align: center;"><?php echo e($datosValues->sipdv); ?></td>
