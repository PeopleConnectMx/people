        ...
        <div class="panel panel-primary">
            <div class="panel-heading" align="center">
                <h3 class="panel-title" >
                    <button type="button" class="btn btn-info" value="envia" onclick="datosastriskSoluciones()" >Obtener datos</button>
                    <?php echo e($value['nombre_completo']); ?> 
                    <button type="button"  class="btn btn-danger" value="enviaRestringido" onclick="datosastriskSolucionesRestringido()" >Obtener datos Restringidos</button>
                </h3> 
            ...
            <div class="panel-body">
                ...
                <div id='contenido' style='display: none;'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('telefono2','',array('class'=>"form-control",'id'=>'telefono2','maxlength'=>'10','minlength'=>'10'))); ?>
...
-->
                    ...
                    <!--
                    <div class="form-group">
                       <?php echo e(Form::label('Tipo fuente','',array('class'=>"col-sm-3 control-label"))); ?>

                       <div class="col-sm-8">
                           <?php echo e(Form::text('tipo_fuente','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'tipo_fiente',))); ?>
                    ...
                    <!--
                    <div class="form-group">
                       <?php echo e(Form::label('Linea marcacion','',array('class'=>"col-sm-3 control-label"))); ?>

                       <div class="col-sm-8">
                           <?php echo e(Form::text('linea_mar','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'linea_mar'))); ?>
...
<script type="text/javascript">
    ...
    function ListaDes1() {
        ...
        opcion10 = new Option("Compania distinta", "Compania distinta");
        opcion11 = new Option("Numero NO comercial", "Numero NO comercial");
        opcion12 = new Option("Linea Movil", "Linea Movil");
        ...
        document.forms.formulario.motivo.options[10] = opcion10;
        document.forms.formulario.motivo.options[11] = opcion11;
        document.forms.formulario.motivo.options[12] = opcion12;
    }
