    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Descarga de audios Soluciones. Número: <?php echo e($telefono); ?> Folio: <?php echo e($id); ?></h3>
            </div>
                    ...
                    <tbody>
                      ...
                      <?php $out = substr($value, 0, 2 ) ?>
                        ...
                        <tr >
                            ...
                            <td>
                                <source src="http://13.85.24.249/Grabaciones_Inbursa/Soluciones/<?php echo e($anio); ?>/<?php echo e($mes); ?>/<?php echo e($dia); ?>/<?php echo e($value); ?>" type="audio/wav"/>
                                <div>
                                    <a type="button" class="btn btn-default" target="_blank" href="http://13.85.24.249/Grabaciones_Inbursa/Soluciones/<?php echo e($anio); ?>/<?php echo e($mes); ?>/<?php echo e($dia); ?>/<?php echo e($value); ?>" ;>
                                        <span class="glyphicon glyphicon-play"></span>
                                    </a>
                                </div>
                            </td>
                            <td>
                               <a href="http://13.85.24.249/Grabaciones_Inbursa/Soluciones/<?php echo e($anio); ?>/<?php echo e($mes); ?>/<?php echo e($dia); ?>/<?php echo e($value); ?>" type="button" class="btn btn-default" download="audio.wav">
