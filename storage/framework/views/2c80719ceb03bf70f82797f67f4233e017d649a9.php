...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <form class="form-horizontal" action="<?php echo e(url('/Inbursa/Calidad/Ventas/Lista')); ?>" method="post">
      <fieldset>
        <legend>Seleccione una fecha</legend>
        <div class="form-group">
          <label for="inputEmail" class="col-lg-2 control-label">Fecha de venta</label>
          <div class="col-lg-8">
