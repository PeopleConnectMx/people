                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="<?php echo e(url('calidad/backoffice/ventas/reporte/'.$value->id.'/'.$fecha_i.'/'.$fecha_f)); ?>"><?php echo e($value->nombre_completo); ?></a></td>
                                        ...
                                        <?php foreach($fechaValue as $valueFecha): ?>
                                            ...
                                            <?php foreach($moni as $key => $valueMoni): ?>
                                                <?php if($valueFecha==$valueMoni->fecha_monitoreo && $value->id==$valueMoni->nombre): ?>
                                                    <?php
                                            ...
                                            <?php else: ?>
                                                <td style='text-align: center;'><a href="<?php echo e(url('calidad/backoffice/ventas/NumMon/'.$value->id.'/'.$valueFecha)); ?>" class='mon'><?php echo e($totalProm); ?> %</a></td>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                        ...
                                        <?php foreach($numMoni as $numMoniValue): ?>
                                            <?php if($value->id==$numMoniValue->nombre): ?>
