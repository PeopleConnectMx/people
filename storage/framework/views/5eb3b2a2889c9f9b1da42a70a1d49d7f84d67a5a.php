                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td class="center"><a href="<?php echo e(url('/calidad/backoffice/ventas/update/'.$ValueMoni->id)); ?>"><?php echo e($ValueMoni->dn); ?></td>
                                        <td><?php echo e($ValueMoni->resultado); ?> %</td>
                                        <td><?php echo e($ValueMoni->fecha_monitoreo); ?></td>
                                        <td><?php echo e($ValueMoni->fecha_llamada); ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
