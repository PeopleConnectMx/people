                    ...
                    <div class="panel-body">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="zui-table table table-bordered" style="width: 25%; padding-left:20px; background: #f4f1ed;">{{ Form::label($valores[0]->id,'') }}</td>
                            </tr>
                            <tr>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table>
                            <thead>
                            <div class="form-group">
                                {{ Form::label('Atención del Ticket','',array('class'=>"col-sm-2 control-label")) }}
                            </div>
                            </thead>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="zui-table table table-bordered" style="width: 25%; padding-left:20px; background: #f4f1ed;">{{ Form::label($valores[0]->nom_encargado,'') }}</td>
                            </tr>
                            <tr>
                                <td class="zui-table table table-bordered" style="width: 6%; padding-right:20px; background: #f4f1ed;" align="right">Asignado</td>
                                <td class="zui-table table table-bordered" style="width: 25%; padding-left:20px; background: #f4f1ed;">{{ Form::label($valores[0]->nom_asignado,'') }}</td>
                            </tr>
                            <tr>
                                ...
                                <td class="zui-table table table-bordered" style="width: 25%; padding-left:20px; background: #f4f1ed;">{{ Form::label($valores[0]->tiempo_estimado,'') }}</td>
                            </tr>
                            <tr>
                                <td class="zui-table table table-bordered" style="width: 6%; padding-right:20px; background: #f4f1ed;" align="right">VoBo del Área</td>
                                <td class="zui-table table table-bordered" style="width: 25%; padding-left:20px; background: #f4f1ed;">{{ Form::label($valores[0]->BoVoSistemas,'') }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
