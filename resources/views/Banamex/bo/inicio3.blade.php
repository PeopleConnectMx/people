        ...
        <div class="col-md-5 col-md-offset-1">
            <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            {{ Form::label('Nombre_completo','',array('class'=>"col-md-5 control-label")) }}
                            <div class="col-md-10">
                                {{ Form::text('nombre_completo',$datos[0]->nombre_completo,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" style='display: none;' id='file' >
                           {{ Form::label('Imagenes','',array('class'=>"col-sm-5 control-label"))}}
                           <div class="col-sm-12">
                               {{ Form::label('Datos Personales','',array('class'=>"col-sm-5 control-label"))}}
                             <div class="col-sm-5" id='lal'>
                                 {{ Form::file('thefile1', ['class' => 'field','required' => 'required','id'=>'filef1']) }}
                             </div>
                           </div>
                           <div class="col-sm-12">
                               {{ Form::label('Domicilio','',array('class'=>"col-sm-5 control-label"))}}
                             <div class="col-sm-5" id='lal'>
                                 {{ Form::file('thefile2', ['class' => 'field','required' => 'required','id'=>'filef2']) }}
                             </div>
                           </div>
                           <div class="col-sm-12">
                               {{ Form::label('Información Financiera','',array('class'=>"col-sm-5 control-label"))}}
                             <div class="col-sm-5" id='lal'>
                                 {{ Form::file('thefile3', ['class' => 'field','required' => 'required','id'=>'filef3']) }}
                             </div>
                           </div>
                           <div class="col-sm-12">
                               {{ Form::label('Información Laboral','',array('class'=>"col-sm-5 control-label"))}}
                             <div class="col-sm-5" id='lal'>
                                 {{ Form::file('thefile4', ['class' => 'field','required' => 'required','id'=>'filef4']) }}
                             </div>
                           </div>
                           <div class="col-sm-12">
                               {{ Form::label('Datos Complementarios','',array('class'=>"col-sm-5 control-label"))}}
                             <div class="col-sm-5" id='lal'>
                                 {{ Form::file('thefile5', ['class' => 'field','required' => 'required','id'=>'filef5']) }}
                             </div>
                           </div>
                           <div class="col-sm-12">
                               {{ Form::label('Folio','',array('class'=>"col-sm-5 control-label"))}}
                             <div class="col-sm-5" id='lal'>
                                 {{ Form::file('thefile6', ['class' => 'field','required' => 'required','id'=>'filef6']) }}
                             </div>
                           </div>
