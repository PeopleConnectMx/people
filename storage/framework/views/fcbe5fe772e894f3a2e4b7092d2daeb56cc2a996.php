                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                ?>
                                    <li><a href="<?php echo e(url('/direccion/proyeccion/prepago/').date('/Y-m-d')); ?>">Planeacion TM Prepago</a></li>
                                ...
                                ?>
                                <li><a href="<?php echo e(url('/prepago/SubirAltas')); ?>">Subir Reporte de Altas</a></li>
                                <li><a href="<?php echo e(url('/prepago/ReporteP1')); ?>">Reporte Proceso 1</a></li>
