...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">Subir de reporte de rechazos Inbursa Soluciones</h3>
  </div>
  <div class="panel-body">

    <form class="form-horizontal" action="{{url('/Inbursa/Reportes/Envio/Rechazos/Guardar')}}" method="post" enctype="multipart/form-data">
      <fieldset>
