                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="{{ url('calidad/prepago/validador/reporte/'.$value->id.'/'.$fecha_i.'/'.$fecha_f) }}">{{ $value->nombre_completo }}</a></td>
                                        ...
                                        @foreach($fechaValue as $valueFecha)
                                            ...
                                            @foreach($moni as $key => $valueMoni)
                                                @if($valueFecha==$valueMoni->fecha_monitoreo && $value->id==$valueMoni->validador)
                                                    <?php
                                            ...
                                            @else
                                                <td style='text-align: center;'><a href="{{ url('calidad/prepago/validador/NumMon/'.$value->id.'/'.$valueFecha) }}" class='mon'>{{ $totalProm }} %</a></td>
                                            @endif
                                        @endforeach
                                        ...
                                        @foreach($numMoni as $numMoniValue)
                                            @if($value->id==$numMoniValue->validador)
