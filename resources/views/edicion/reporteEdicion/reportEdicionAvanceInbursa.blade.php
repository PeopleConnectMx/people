    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Reporte edición por avance</h3>
            </div>
            <div class="panel-body">

                {{ Form::open(['action' => 'EdicionController@reporteAvenEditados',
                                'method' => 'post',
                ...
                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                      <?php $inbursa = 'Inbursa'; ?>
                        ...
                        {{ Form::text('campaign',$inbursa,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                    </div>
                </div>
