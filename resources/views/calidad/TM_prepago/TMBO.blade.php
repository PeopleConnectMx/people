@extends('layout.calidad.TM_prepago.TMBlackof')
@section('content')
          ...
          <h3 class="panel-title">Periodo </h3>
            ...
            <div class="panel-body">
              <table class="table table-striped" style="background-color: #AFE1F3">
                ...
                <tr>
                  <th style='text-align: center;' class="container text-center"> Nombre del Analista de BO</th>
                  ...
                  <th style='text-align: center;' class="info"> Resultados Total</th>
