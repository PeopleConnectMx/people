                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">DN no validados Inbursa</h3>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-page-length='100'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(url('/calidad/prepago/novalidadoInbursa/'.$value->telefono)); ?>"><?php echo e($value->telefono); ?></a></td>
