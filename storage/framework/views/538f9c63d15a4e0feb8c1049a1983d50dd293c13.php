...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">Envio de reporte de validaciones Inbursa</h3>
  </div>
  <div class="panel-body">

    <form class="form-horizontal" action="<?php echo e(url('/Inbursa/Reportes/Envio/Validaciones/Guardar')); ?>" method="post" enctype="multipart/form-data">
      <fieldset>
