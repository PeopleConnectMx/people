...
<div class="container-fluid">
  ...
  <div class="col-md-6 col-md-offset-1">
    ...
    @if ($Vista== "Agenda")
    {{ Form::open(['action' => 'AuriController@SaveAgenda',
                    'method' => 'post',
    ...
    @if ($Vista== "Agente")
    {{ Form::open(['action' => 'AuriController@SaveAgente',
                    'method' => 'post',
                    'class'=>"form-horizontal",
                    'accept-charset'=>"UTF-8",
                    'enctype'=>"multipart/form-data"
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-8">
        <input type="text" class="form-control" id="inputEmail" value="{{$datos[0]->MARCA}}" disabled="">
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Empresa</label>
      <div class="col-lg-8">
        <input type="text" class="form-control" id="inputEmail" value="{{$datos[0]->EMPRESA}}" disabled="">
      </div>
    </div>
    <div class="form-group">
      <label for="inputPassword" class="col-lg-2 control-label">Nombre</label>
      <div class="col-lg-8">
        <input type="text" class="form-control" id="inputEmail" value="{{$datos[0]->TITULO}} {{$datos[0]->NOMBRE}} {{$datos[0]->APELLIDOS}}" disabled="">
      </div>
    </div>
    <div class="form-group">
      <label for="inputPassword" class="col-lg-2 control-label">Puesto</label>
      <div class="col-lg-8">
        <input type="text" class="form-control" id="inputEmail" value="{{$datos[0]->PUESTO}}" disabled="">
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Teléfono</label>
      <div class="col-lg-8">
        <input type="text" class="form-control" id="telefono" value="{{$datos[0]->telefono}}" disabled="">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-8">
        <input type="text" class="form-control" id="inputEmail" value="{{$datos[0]->TELS}}" disabled="">
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Email</label>
      <div class="col-lg-8">
        <input type="text" class="form-control" id="inputEmail" value="{{$datos[0]->E_MAIL}}" disabled="">
      </div>
    </div>
    <!-- datos envio -->
    <input name="id" type="hidden" value="{{$datos[0]->id}}">
    <div class="form-group">
