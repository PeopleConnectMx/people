                      ...
                      <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              ...
                              <li><a href="{{ url('/EdicionEdi') }}">Reporte de Edición por edito</a></li>
                              <li><a href="{{ url('/EdicionAva') }}">Reporte de Edición por avance</a></li>
                              <li><a href="{{ url('/EdicionEsta') }}">Reporte de Edición por Estatusr</a></li>
...
<!--                              <li><a href="/reporteMarcacionContactacionDiaMapfre">Marcacion contactacion por dia Mapfre</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/Administracion/root/plantillaV2') }}">Plantilla version minimizada</a></li>
<!--
                                <li><a href="{{ url('/Administracion/root/asistencia') }}">Reporte asistencia</a></li>
                                <li><a href="{{ url('/capacitacionRoot') }}">Reporte de Capacitacion</a></li>
                                <li><a href="{{ url('/Administracion/ReporteRooot') }}">Reporte Reclutamiento</a></li>
-->
                                ...
                                <li><a href="{{ url('/Administracion/root/PendienteAlta') }}">Pendiente de Alta</a></li>
<!--
                                <li><a href="{{ url('/Administracion/operaciones/reporte') }}">Reporte general de operaciones</a></li>
                                <li><a href="{{ url('/Administracion/periodoIncidencia') }}">Reporte de Incidencias</a></li>
-->
...
<!--
                                ...
                                <li><a href="{{ url('/Administracion/reporteMarcacionEstado') }}">Reporte de Marcacion general</a></li>
                                <li><a href="{{ url('/Administracion/reporteMarcacionContactacionDia') }}"> Reporte de contactacion por dia</a></li>
                                <li><a href="{{ url('/Administracion/reporteMarcacionConversionDia') }}"> Reporte de conversion por dia </a></li>
