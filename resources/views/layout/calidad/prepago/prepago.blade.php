                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="{{ url('/calidad/prepago/novalidadoInbursa') }}">No Validado Inbursa</a></li>
                                    <li><a href="{{ url('/calidad/prepago/novalidadoBanamex') }}">No Validado Banamex</a></li>
                                    @if(session('puesto')=='Analista de Calidad'&&session('campaign')=='Banamex')
                                        <li><a href="{{ url('/BoBanamex') }}">Audios Banamex</a></li>
                                    @endif
                                    <li><a href="{{ url('/rechazos') }}">Rechazos</a></li>
                                    <li><a href="{{ url('/calidad/jefeCalidad/perMonitoreoAC') }}">Reporte de calidad</a></li>
                                    <li><a href="{{ url('/calidad/prepago/quejas') }}">Quejas</a></li>
