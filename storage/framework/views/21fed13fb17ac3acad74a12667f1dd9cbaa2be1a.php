...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <?php echo e(Form::open(['action' => 'ValidacionInbController@UpdateDatos',
                                'method' => 'post',
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('id',$datos[0]->id,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Telefono','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('telefono',$datos[0]->telefono,array('class'=>"form-control", 'placeholder'=>"",'id'=>'telefono','maxlength'=>'10'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('paterno',$datos[0]->ap_paterno,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'paterno'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('materno',$datos[0]->ap_materno,array('class'=>"form-control", 'placeholder'=>"",'id'=>'materno'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('nombre',$datos[0]->nombre,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'nombre'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Fecha de nacimiento del titular de la póliza','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::date('fechaNacimiento',$datos[0]->fecnacaseg,array('class'=>"form-control", 'placeholder'=>"********",'id'=>'fechaNacimiento'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Nombre de la persona que autoriza el seguro','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('nombreAutoriza',$datos[0]->autoriza,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'autoriza'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Parentesco','',array('class'=>"col-sm-2 control-label"))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Correo Electrónico','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::email('email',$datos[0]->correo,array('class'=>"form-control",'id'=>'correo'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Fecha en que se hizo el movimiento','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::date('fechaMovimiento',$datos[0]->fecha_capt,array('class'=>"form-control", 'placeholder'=>"********",'id'=>'fechaMov'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Dirección','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('direccion',$datos[0]->direccion,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'direccion'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Vialidad','',array('class'=>"col-sm-2 control-label"))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Vivienda','',array('class'=>"col-sm-2 control-label"))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Número interior','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('numint',$datos[0]->numint,array('class'=>"form-control", 'placeholder'=>"",'id'=>'nunInt'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Piso','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('piso',$datos[0]->piso,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'piso'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Tipo de asentamiento','',array('class'=>"col-sm-2 control-label"))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('colonia',$datos[0]->colonia,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'col'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Código postal','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('cp',$datos[0]->codpos,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'cp'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('ciudad',$datos[0]->ciudad,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'ciudad'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::label('Entré calles','',array('class'=>"control-label"))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::label('Calle 1','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('calle_1',$datos[0]->calle_1,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'calle_1'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Calle 2','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('calle_2',$datos[0]->calle_2,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'calle_2'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('ref_1',$datos[0]->ref_1,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'ref_1'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('ref_2',$datos[0]->ref_2,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'ref_2','maxlength'=>'4'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('RVT','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('rvt',$datos[0]->rvt,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>""))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('validador',$value['user'],array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly'))); ?>

                    </div>
                </div>

                <div class="form-group">
                    <?php echo e(Form::label('# de pisos de la construcción','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::text('num_pisos',$datos[0]->num_pisos,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'title'=>'La planta baja cuenta como Piso 1','id'=>'pisos'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Tipo de material del techo de la vivienda','',array('class'=>"col-sm-2 control-label"))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Cuerpo de agua cercana al domicilio','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::select('tipofuente', [
                        'MAR' => 'MAR',
                        'LG' => 'LG',
                        'LGA'=> 'LGA',
                        'RIO'=>'RIO',
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Distancia al cuerpo del agua','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                        <?php echo e(Form::select('linea_mar', [
                        'SI' => 'SI',
                        'NO' => 'NO'],
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Estatus interno','',array('class'=>"col-sm-2 control-label"))); ?>
