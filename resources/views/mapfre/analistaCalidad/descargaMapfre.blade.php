    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Auditoría de Audios {{$telefono}} || {{$poliza}}</h3>
            </div>
            <div class="panel-body">

    {{ Form::open(array(
         'url'=>'Mapfre/uploadMapfre',
         'method' => 'post',
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <!--oobtiene la hora de la llamada-->
                        ...
                        <tr >
                            ...
                            <td>
                                <source src="http://192.168.10.90/Edicion/Mapfre/{{$anio}}/{{$mes}}/{{$dia}}/{{$value}}" type="audio/wav"/>
                                <div>
                                    <a type="button" class="btn btn-default" target="_blank" href="http://192.168.10.90/Mapfre/{{$anio}}/{{$mes}}/{{$dia}}/{{$value}}"" ;>
                            ...
                            <td>
                               <a href="http://192.168.10.90/Mapfre/{{$anio}}/{{$mes}}/{{$dia}}/{{$value}}" type="button" class="btn btn-default" download="audio.wav">
