        ...
        <header>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{url('InicioChatFacebook')}}" >TM Prepago Supervisor Chat</a>
                </div>

                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                      <!--  <li><a class="glyphicon glyphicon-warning-sign" href="{{ url('/NuevoTicket') }}"></a></li> -->
                      <li><a class="glyphicon glyphicon-registration-mark" href="{{ url('/chatFBRevisar') }}"></a></li>
