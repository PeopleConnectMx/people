@extends('layout.VivaAnuncios.mapfre')
@section('content')
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                {{ Form::open(['action' => 'VivaAnunciosController@mapfreGuarda',
                              'method' => 'post',
                ...
                <div id='contenido'>
                    ...
                    <div class="form-group">
                        {{ Form::label('¿Esta pensando comprar algún / otro coche?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::select('esta_pensando', [
                                        'SI' => 'SI',
                                        'NO' => 'NO'],
                    ...
                    <div class="form-group">
                        {{ Form::label('Año de su auto','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
                            {{ Form::date('anio_auto',date('Y-m-d'),array('class'=>"form-control", 'placeholder'=>"",'id'=>'anio_auto')) }}
                        </div>
                    </div>

                    <div class="form-group">
                        {{ Form::label('¿Para terminar, puedo confirmar su cotización?','',array('class'=>"col-sm-3 control-label")) }}
                        <div class="col-sm-8">
