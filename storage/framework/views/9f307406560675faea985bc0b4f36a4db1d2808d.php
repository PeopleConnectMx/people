    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <?php echo e(Form::open(['action' => 'CitasController@verCandidato',
                                'method' => 'post',
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        'Doble Turno'=>'Doble Turno'],$user[0]->turno, ['required' => 'required', 'class'=>"form-control", 'placeholder'=>""]  )); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        '14:00:00'=>'14:00 pm',
                        '16:00:00'=>'16:00 pm'],
                        date("H:i:s", strtotime($user[0]->fecha_cita)), ['class'=>"form-control", 'placeholder'=>""]  )); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        'Direccion General'=>'Direccion General'],$user[0]->area, ['required' => 'required', 'class'=>"form-control", 'placeholder'=>"", "onchange"=>"LlenarSelect()"]  )); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      'Analis de Calidad'=>'Analis de Calidad',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('telefono_fijo',$user[0]->telefono_fijo,array('class'=>"form-control", 'placeholder'=>"55345678"))); ?>
                ...
                <div class="form-group">
                   ...
                   <div class="col-sm-10">
                       <?php echo e(Form::text('telefono_cel',$user[0]->telefono_cel,array('class'=>"form-control", 'placeholder'=>"5511223344"))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('email',$user[0]->email,array('class'=>"form-control"))); ?>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    $user[0]->estatus_cita, ['required' => 'required', 'class'=>"form-control Fase2", 'placeholder'=>"", 'id'=>"Fase1"]  )); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        'No acepta' => 'No acepta',
                        'En espera' => 'En espera'],
                    $user[0]->resultado_cita, ['required' => 'required', 'class'=>"form-control Fase3", 'placeholder'=>"", 'id'=>"Fase3"] )); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::date('fechaCapacitacion',$user[0]->fecha_capacitacion,array('required' => 'required', 'class'=>"form-control Fase3", 'placeholder'=>"", 'id'=>"Fase3"))); ?>
                ...
                <div class="form-group">
                    ...
                    $user[0]->nombre_capacitador, ['required' => 'required', 'class'=>"form-control Fase3", 'placeholder'=>"", 'id'=>"Fase3"] )); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        'En espera' => 'En espera'],
                    $user[0]->estado_capacitacion, ['required' => 'required', 'class'=>"form-control Fase3", 'placeholder'=>"", 'id'=>"Fase3"] )); ?>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <?php echo e(Form::submit('Enviar',['class'=>"btn btn-default",'onClick'=>'return confirm("seguro que desea guardar la información")'])); ?>
