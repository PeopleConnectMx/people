    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(['action' => 'RechazosController@CapturaUpdate',
                                'method' => 'post',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    {{ Form::text('nip',$bo[0]['nip'],array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"")) }}
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::textarea('comentarios',$bo[0]['comentarios'],array('required' => 'required','class'=>"form-control", 'placeholder'=>"")) }}
                    </div>
                </div>
