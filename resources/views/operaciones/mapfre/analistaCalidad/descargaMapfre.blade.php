                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <!--oobtiene la hora de la llamada-->
                        ...
                        <tr >
                            ...
                            <td>
                                <source src="http://192.168.10.20:257/Mapfre/{{$anio}}/{{$mes}}/{{$dia}}/{{$value}}" type="audio/wav"/>
                                <div>
                                    <a type="button" class="btn btn-default" target="_blank" href="http://192.168.10.20:257/Mapfre/{{$anio}}/{{$mes}}/{{$dia}}/{{$value}}"" ;>
                            ...
                            <td>
                               <a href="http://192.168.10.20:257/Mapfre/{{$anio}}/{{$mes}}/{{$dia}}/{{$value}}" type="button" class="btn btn-default" download="audio.wav">
