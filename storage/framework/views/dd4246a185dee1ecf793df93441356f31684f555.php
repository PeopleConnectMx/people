            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Sistemas los Dioses</a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(url('/nuevoProyecto')); ?>">Nuevo Proyecto</a></li>
                                    <li><a href="<?php echo e(url('/ListaProyecto')); ?>">Lista de Proyecto</a></li>
                                </ul>
                            </li>
