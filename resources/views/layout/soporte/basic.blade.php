                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a href="{{ url('/subirReporteBlaster') }}">Blaster</a></li>
                              <li><a href="{{ url('/subirReporteInbursa') }}">Inbursa</a></li>
                              <li><a href="{{ url('/subirReporteTelefonica') }}">Telefonica</a></li>
                              <li><a href="{{ url('/ListaSistemaTicket') }}">Ver Ticket</a></li>

                              <!-- <li><a href="{{ url('/nomina/tm/facebook') }}">Facebook</a></li>
                              <li><a href="{{ url('/nomina/inbursa') }}">Inbursa</a></li> -->
