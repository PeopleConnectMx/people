                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo e(url('/subirReporteBlaster')); ?>">Blaster</a></li>
                              <li><a href="<?php echo e(url('/subirReporteInbursa')); ?>">Inbursa</a></li>
                              <li><a href="<?php echo e(url('/subirReporteTelefonica')); ?>">Telefonica</a></li>
