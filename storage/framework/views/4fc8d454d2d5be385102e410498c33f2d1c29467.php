...
<!-- -######################  Inbursa Soluciones #####################-->
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary">
            ...
            <?php foreach($valf9 as $key=>$value): ?>
              <?php if(array_key_exists($key,$valf9)): ?>
                <div class="panel-body" style="display:true" id='fechaInbSol<?php echo e($contInbSol); ?>'>
                  <div align='center'>
                    <table>
                      <tr>
                        <?php echo e(Form::button('',['class'=>"btn btn-primary glyphicon glyphicon-triangle-left", "onClick"=>"backInbSol()"])); ?>
                      ...
                      <tr>
                        <?php echo e(Form::button('',['class'=>"btn btn-primary glyphicon glyphicon-triangle-right", "onClick"=>"nextInbSol()"])); ?>

                      </tr>
                    </table>
                  </div>

                <table class="table table-striped table-bordered table-hover" id="dataTables-exampleInbSol<?php echo e($contInbSol); ?>">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Supervisor</th>
                  ...
                  <tbody>
                    <?php $con=0; $mat=0; $ves=0; $ventmat=0;$ventves=0;?>
                    <?php foreach($valf9[$key] as $key2 => $value2): ?>
                    <tr>
                      <?php $con=$con+1; ?>
                       <td><?php echo e($con); ?></td>
                       <?php if($value2['nameSup']==null): ?>
                         <td ><a href="<?php echo e(url('Administracion/operaciones/agente/'.$key2.'/'.$key.'/InbursaSoluciones')); ?>">Sin Supervisor</a></td>
                       <?php else: ?>
                         <td ><a href="<?php echo e(url('Administracion/operaciones/agente/'.$key2.'/'.$key.'/InbursaSoluciones')); ?>"><?php echo e($value2['nameSup']); ?></a></td>
                       <?php endif; ?>
                        <td><?php echo e($value2['numM']); ?></td>   <!-- Toal de Plantilla Matunino-->
                        <td><?php echo e($value2['numV']); ?></td>
                        <td><?php echo e($value2['ventasM']); ?></td>   <!--Ventas Matutino-->
...
<script>
    ...
    $(document).ready(function () {
        ...
        limitInbSol=<?php echo e($numInbSol); ?>;
        // --------- movistar
          <?php foreach($valf as $key=>$value): ?>
        ...
        // --------- Inbursa Soluciones
          <?php foreach($valf9 as $key=>$value): ?>
          $("#fechaInbSol<?php echo e($valInbSol); ?>").hide();
          $('#dataTables-exampleInbSol<?php echo e($valInbSol); ?>').DataTable({
              responsive: true,
              "order": [[ 6, 'desc' ]]
          });
          <?php $valInbSol++; ?>
