    ...
    <div class="col-lg-8 col-lg-offset-2">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Reporte de calidad por supervisor</h3>
            </div>
              ...
              <div class="zui-wrapper">
                ...
                <table class="zui-table table-condensed table-bordered">
                  <tr>
                    ...
                    <th rowspan="2" class="zui-sticky-col-2" style="height: 61px; padding-top:20px; background: #f4f1ed;">Supervisor</th>
