    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              {{ Form::open(['action' => 'Bancomer2Controller@Guarda',
                              'method' => 'post',
...
function Encuesta(){
  if($("#numselect").val()!='' && $("#segmento").val()!='' && $("#mora").val()!=''){
    ...
    $.when(ajax()).done(function(){
      vent='https://es.research.net/r/irene_hipotecario_ind?credito_otorgado=['+$("#credito_otorgado").val()+']&credito_mayor_3millones=['+credito+']&empresa=['+$("#empresa").val()+']&cr=['+$("#cr").val()+']&id_encuesta=['+$("#nameNum").val()+']';
  ...
  function ajax(){
    ...
    return $.ajax({
      url:   "/Bancomer_2/audio/"+newNum+"/"+$("#fecha").val(),
      type:  'get',
      beforeSend: function () {
        console.log('espere');
      },
