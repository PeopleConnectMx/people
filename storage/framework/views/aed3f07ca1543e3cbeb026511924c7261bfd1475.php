        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('ref_1',$datos[0]->tel_casa,array('required' => 'required', 'class'=>"form-control",
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('ref_2',$datos[0]->tel_oficina,array('required' => 'required', 'class'=>"form-control",
                                  'placeholder'=>"", 'readonly'=>''))); ?>
                ...
                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                        <?php echo e(Form::text('id',$datos[0]->b_id,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly'))); ?>
