...
<div id='contenido' style='display: none;'>
                                ...
                                <div class="form-group">
                                    <?php echo e(Form::label('Telefono marcado *','',array('class'=>"col-sm-3 control-label"))); ?>

                                    <div class="col-sm-8">
                                        <?php echo e(Form::text('telefono','',array('class'=>"form-control",'id'=>'telefono', 'required' => 'required','maxlength'=>'10','minlength'=>'10'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <?php echo e(Form::text('correo','',array('class'=>"form-control",'id'=>'correo'))); ?>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                             <?php echo e(Form::text('town','',array('class'=>"form-control",'id'=>'town'))); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                             <?php echo e(Form::text('col','',array('class'=>"form-control",'id'=>'col'))); ?>
