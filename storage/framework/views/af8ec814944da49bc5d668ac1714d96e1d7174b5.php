...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <?php echo e(Form::open(['action' => 'InbursaVidatelController@UpdateFromularioInbVidatel',
                                'method' => 'post',
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <?php echo e(Form::date('fecnacaseg',$datos[0]->fecnacaseg,array('class'=>"form-control",'id'=>'fecnacaseg'))); ?>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <?php echo e(Form::text('num_ext',$datos[0]->num_ext,array('class'=>"form-control", 'placeholder'=>"",'id'=>'num_ext'))); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <?php echo e(Form::text('cp',$datos[0]->codpos,array( 'class'=>"form-control", 'placeholder'=>"",'id'=>'cp'))); ?>
                                  ...
                                  <div class="form-group">
                                      <?php echo e(Form::label('Campaña celular','',array('class'=>"col-sm-3 control-label"))); ?>

                                      <div class="col-sm-8">
                                          <?php echo e(Form::text('comp_cel',$datos[0]->comp_cel,array( 'class'=>"form-control", 'placeholder'=>"",'title'=>'La planta baja cuenta como Piso 1','id'=>'pisos'))); ?>
