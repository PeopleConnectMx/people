    ...
    <div class="col-md-12 ">
        <div class="panel panel-primary">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Descarga de Audios <?php echo e($datos[0]->v_id); ?></h3>
            </div>
            <?php endif; ?>
            
            <?php if(session('puesto')=='Analista de BO Banamex'): ?>
            <div class="panel-heading">
              ...
              <div class="modal-dialog" role="document" style="width:1250px; height:550px;">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <img src="<?php echo e(asset('')); ?>" height="550" width="1200" id='imaf'>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
            <div class="panel-body">
              ...
              <?php echo e(Form::open(['action' => 'BoBanamexController@BackOfficeRegistroGuarda',
                              'method' => 'post',
                        ...
                        <div class="form-group col-sm-12">
                          <div class="col-sm-8">
                            <div class="form-group">
                                <?php echo e(Form::label('Datos Personales','',array('class'=>"col-sm-3 control-label"))); ?>
                          ...
                          <div class="col-sm-3">
                            <img src="<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/1_'.$name_image)); ?>" height="350" width="450" id='imaf1' data-toggle="modal" data-target="#myModal"  >
                          </div>
                        </div>
                      ...
                      <div class="form-group col-sm-12">
                        <div class="col-sm-8">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <?php echo e(Form::text('colonia_co',$datos[0]->colonia,array('id'=>'colonia_co','required' => 'required', 'class'=>"form-control", 'placeholder'=>""))); ?>
                        ...
                        <div class="col-sm-3">
                          <img src="<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/2_'.$name_image)); ?>" height="350" width="450" id='imaf2' data-toggle="modal" data-target="#myModal">
                        </div>
                      </div>
                          <!-- *********************** -->
                      <div class="form-group col-sm-12">
                        <div class="col-sm-8">
                          ...
                          <div class="form-group">
                            ...
                            <?php echo e(Form::label('Numero de tarjeta(ultimos 4 digitos)','',array('class'=>"col-sm-4 col-md-offset-1 control-label"))); ?>
                          ...
                          <div class="form-group">
                            ...
                            <?php echo e(Form::label('¿Tienes un credito Automotriz?(aperturado ultimos 2 años)','',array('class'=>"col-sm-4 col-md-offset-2 control-label"))); ?>
                        ...
                        <div class="col-sm-3">
                          <img src="<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/3_'.$name_image)); ?>" height="350" width="450" id='imaf3' data-toggle="modal" data-target="#myModal">
                        </div>
                        </div>
                          <!-- ************************************ -->
                      <div class="form-group col-sm-12">
                        <div class="col-sm-8">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <?php echo e(Form::text('coloniaEmpleo_co',$datos[0]->colonia_empresa,array('id'=>'coloniaEmpleo_co','required' => 'required', 'class'=>"form-control", 'placeholder'=>""))); ?>
                        ...
                        <div class="col-sm-3">
                          <img src="<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/4_'.$name_image)); ?>" height="350" width="450" id='imaf4' data-toggle="modal" data-target="#myModal">
                        </div>
                        </div>
                          <!-- *********************************** -->
                      <div class="form-group col-sm-12">
                        <div class="col-sm-8">
                          ...
                          <div id="nac"><!-- nacional -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                  <?php echo e(Form::text('lada_co',$datos[0]->lada_referencia_personal,array('id'=>'lada_co','class'=>"form-control", 'placeholder'=>""))); ?>
                      ...
                      <div class="col-sm-3">
                        <img src="<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/5_'.$name_image)); ?>" height="350" width="450" id='imaf5' data-toggle="modal" data-target="#myModal">
                      </div>
                      </div>
                      <div style="display:none">
                        <?php echo e(Form::text('venta',$datos[0]->v_id,array('class'=>"form-control", 'placeholder'=>""))); ?>

                      </div>
                        <!--by amy
                          °w° agregadas dos tablas en las cuales estan los audios y la carga de los audios-->
                        <?php endif; ?>
                        <?php if(session('puesto')=='Analista de Calidad'): ?>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                    <?php foreach($audios as $key => $values): ?>
                    <!--obtiene la hora de la llamada-->
                        ...
                        <tr >
                            <td>
                                <source src="http://192.168.10.6:256/Grabaciones/Banamex/<?php echo e($anio); ?>/<?php echo e($mes); ?>/<?php echo e($dia); ?>/<?php echo e($values); ?>" type="audio/wav"/>
                                <div>                                    
                                    <a type="button" class="btn btn-default" target="_blank" href="http://192.168.10.6:256/Grabaciones/Banamex/<?php echo e($anio); ?>/<?php echo e($mes); ?>/<?php echo e($dia); ?>/<?php echo e($values); ?>" ;>
                                        <span class="glyphicon glyphicon-play"></span>
                                    </a>
                                </div>
                            </td>
                            <td>
                               <a href="http://192.168.10.6:256/Grabaciones/Banamex/<?php echo e($anio); ?>/<?php echo e($mes); ?>/<?php echo e($dia); ?>/<?php echo e($values); ?>" type="button" class="btn btn-default" download="audio.wav">
...
<script>
  var co_col_emp="<?php echo e($datos[0]->colonia_empresa); ?>";
  var r_co_col_emp=reem(co_col_emp);
  var co_col="<?php echo e($datos[0]->colonia); ?>";
...
console.log('<?php echo e($datos[0]->lugar_nacimiento); ?>');
console.log('<?php echo e($datos[0]->nacionalidad); ?>');


    $("#imaf1").click(function(){
      console.log("<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/1_'.$name_image)); ?>");
      $("#imaf").attr('src',"<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/1_'.$name_image)); ?>");
     });
    $("#imaf2").click(function(){
      $("#imaf").attr('src',"<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/2_'.$name_image)); ?>");
     });
    $("#imaf3").click(function(){
      $("#imaf").attr('src',"<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/3_'.$name_image)); ?>");
     });
    $("#imaf4").click(function(){
      $("#imaf").attr('src',"<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/4_'.$name_image)); ?>");
     });
    $("#imaf5").click(function(){
      $("#imaf").attr('src',"<?php echo e(asset('assets/img/Banamex/'.$datos[0]->anio.'/'.$datos[0]->mes.'/'.$datos[0]->dia.'/5_'.$name_image)); ?>");
     });
    ...
    $('#diaNacimiento_co > option[value="'+<?php echo e(date("d",strtotime($datos[0]->fecha_nacimiento))); ?>+'"]').attr('selected', 'selected');
    $('#yearNacimiento_co > option[value="'+<?php echo e(date("Y",strtotime($datos[0]->fecha_nacimiento))); ?>+'"]').attr('selected', 'selected');
    console.log(<?php echo e(date("Y",strtotime($datos[0]->fecha_nacimiento))); ?>);
