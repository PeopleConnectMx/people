                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/bo/perRefRep') }}">Referencia Repetidas</a></li>
                                <li><a href="{{ url('/bo/reporteTipificacion') }}">Marcaciones de Back-Office</a></li>
                                <li><a href="{{ url('/Administracion/root/asistencia') }}">Reporte asistencia</a></li>
                                <li><a href="{{ url('/bo/PeriodoMarcacionBO') }}">Reporte Marcacion</a></li>
                                <li><a href="{{ url('/reporteRV') }}">Reporte de ventas completo</a></li>
                                <li><a href="{{ url('/bo/altas') }}">Subir Reporte de Altas</a></li>
                                <li><a href="{{ url('/reporteHistorico') }}">Reporte Historico de BO</a></li>
                                <li><a href="{{ url('/bo/marcacion') }}">Reporte Marcacion/ventas</a></li>
                                <li><a href="{{ url('/bo/marcacion2') }}">Reporte Marcacion/ventas 2</a></li>
                                <li><a href="{{ url('/bo/wa') }}">Genera base WhatsApp</a></li>
                                <li><a href="{{ url('/ValidadoresVidatel')}}">Reporte Validaciones Vidatel</a></li>
                                <li><a href="{{ url('/Estatus_Proceso1')}}">Monitoreo P1</a></li>
