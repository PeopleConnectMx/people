    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <?php echo e(Form::open(['action' => 'FaceBookVentasController@UpdateDatos',
                              'method' => 'post',
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <?php echo e(Form::text('dn',$datos[0]->dn,array('class'=>"form-control", 'placeholder'=>"",'onChange'=>'validacion(this.value)','id'=>'telefono','maxlength'=>'10','required' => 'required'))); ?>
              ...
              <?php if($datos[0]->sipdv=='No Prospecto'): ?>
