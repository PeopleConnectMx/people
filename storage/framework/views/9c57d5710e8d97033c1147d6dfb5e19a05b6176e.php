    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <?php echo e(Form::open(['action' => 'Bancomer3Controller@Guarda',
                              'method' => 'post',
                ...
                <div class="form-group"  align='Center'>
                    ...
                    <div class="col-sm-2" >
                      ...
                      'Suspendido - Fuera de servicio'=>'Suspendido - Fuera de servicio',
                      ],
                ...
                <div id="exist" style='display:none' > <!-- si encuentra dn -->
                  <div class="form-group">
                      ...
                      <?php echo e(Form::label('Nu Consecutivo','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('nu_consecutivo','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'nu_consecutivo'))); ?>

                      </div>
                      <?php echo e(Form::label('CR','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('cr','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'cr'))); ?>

                      </div>
                  </div>
                  <div class="form-group">
                      <?php echo e(Form::label('FDE Fondeo','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('fde_fondeo','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'fde_fondeo'))); ?>

                      </div>
                      <?php echo e(Form::label('Firma','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('firma','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'firma'))); ?>

                      </div>
                      <?php echo e(Form::label('Nom Oficina','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('nom_oficina','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'nom_oficina'))); ?>

                      </div>
                  </div>
                  <div class="form-group">
                      <?php echo e(Form::label('Zona BH 10','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('zona_bh_10','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'zona_bh_10'))); ?>
                      ...
                      <?php echo e(Form::label('Valor de Vivienda','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('valor_de_vivienda','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'valor_de_vivienda'))); ?>

                      </div>
                  </div>
                  <div class="form-group">
                      <?php echo e(Form::label('Credito Otorgado','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('credito_otorgado','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'credito_otorgado'))); ?>

                      </div>
                      <?php echo e(Form::label('SUBPRO','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('subpro','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'subpro'))); ?>

                      </div>
                      <?php echo e(Form::label('NB Promotor','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('nb_promotor','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'nb_promotor'))); ?>

                      </div>
                  </div>
                  <div class="form-group">
                      <?php echo e(Form::label('NB Grupo','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('nb_grupo','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'nb_grupo'))); ?>

                      </div>
                      <?php echo e(Form::label('Empresa','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('empresa','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'empresa'))); ?>

                      </div>
                      <?php echo e(Form::label('Programa ADA','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('programa_ada','',array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'programa_ada'))); ?>

                      </div>
                  </div>
                  <div class="form-group">
                      <?php echo e(Form::label('DUG','',array('class'=>"col-sm-1 control-label"))); ?>

                      <div class="col-sm-3">
                          <?php echo e(Form::text('dug','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'dug','readonly'=>'readonly'))); ?>
