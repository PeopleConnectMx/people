    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(['action' => 'ReportesController@Update',
                                'method' => 'post',
                ...
                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                        {{ Form::text('campaignGet',$campaign,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                    </div>
                </div>

                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                        {{ Form::text('turnoGet',$turno,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                    </div>
                </div>

                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                        {{ Form::text('supervisorGet',$supervisor,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                    </div>
                </div>

                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                        {{ Form::text('estatusGet',$estatus,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  $usuario[0]->puesto, ['required' => 'required', 'class'=>"form-control",'id'=>'puesto', 'placeholder'=>"",'onChange'=>'validacion()']  ) }}
                    </div>
                </div>
