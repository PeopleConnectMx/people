        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <!-- <div class="form-group">
                    {{ Form::label('id','',array('class'=>"col-sm-3 control-label")) }}
                    <div class="col-sm-8">
                        {{ Form::text('idr','',array('class'=>"form-control",'id'=>'idr','required' => 'required')) }}
                    </div>
                </div>                                
                               -->
                <div class="form-group">
                ...
                <div id='contenido' style='display: none;'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::text('ap_paterno','',array('class'=>"form-control",'id'=>'ap_paterno', 'required' => 'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::text('ap_materno','',array('class'=>"form-control",'id'=>'ap_materno', 'required' => 'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::text('nombre','',array('class'=>"form-control",'id'=>'nombre', 'required' => 'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::date('fecnacaseg','',array('class'=>"form-control",'id'=>'fecnacaseg', 'required' => 'required')) }}
                        </div>
                    </div>
...
'', [ 'class'=>"form-control", 'placeholder'=>"",'id'=>'estatus_movimiento']  ) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::text('direccion','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'direccion', 'required' => 'required')) }}
                        </div>
                    </div>
...
-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {{ Form::text('num_pisos','',array('class'=>"form-control", 'placeholder'=>"No puede ser mayor al valor en el Campo Piso",'id'=>'num_pisos')) }}
                        </div>
                    </div>
