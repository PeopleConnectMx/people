        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::select('divicion', [
                            ...
                            'Sistemas' => 'Sistemas',
                            'Soporte' => 'Soporte'],
                        $valores[0]->divicion, ['class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly']  )); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo e(Form::text('descripcion',$valores[0]->descripcion,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>""))); ?>
