                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  ...
                                  <?php foreach($datosArray as $key => $value): ?>
                                    <tr>
                                        <td> <a href="<?php echo e(url('calidad/pospago/ventas/reporte/'.$value['id'].'/'.$fecha_i.'/'.$fecha_f)); ?>"><?php echo e($value['nombre']); ?></a></td>
                                        ...
                                        <?php foreach($fechaValue as $valueFecha): ?>
                                          ...
                                          <?php if( $value['calidad'.$valueFecha]==="--" ): ?>
                                            <td>--</td>
                                          <?php else: ?>
                                            <td><a href="<?php echo e(url('calidad/pospago/ventas/NumMon/'.$value['id'].'/'.$valueFecha)); ?>"><?php echo e($value['calidad'.$valueFecha]); ?></a></td>
                                          <?php endif; ?>
...
<?php echo $__env->make('layout.calidad.pospago.pospago', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>