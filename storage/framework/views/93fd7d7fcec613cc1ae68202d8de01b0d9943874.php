...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="jumbotron">
            ...
            <p><a href="<?php echo e(url('Administracion/admin')); ?>" class="btn btn-primary btn-lg">Registrar nuevo usuario</a></p>
            <?php else: ?>
            <h1>Usuario actualizado </h1>
            <p>Los datos de <b><?php echo e($nombre); ?></b> fueron actualizados # empleado <b> <?php echo e($id); ?>. </b></p>
            <p><a href="<?php echo e(url('/coordinador')); ?>" class="btn btn-primary btn-lg">Ver plantilla</a></p>
            <?php endif; ?>
        </div>
