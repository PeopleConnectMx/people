        ...
        <div class="panel panel-primary">
            <div class="panel-heading" align="center">
                <h3 class="panel-title" >
                    <button type="button" class="btn btn-info" value="envia" onclick="datosastriskSoluciones()" id="od" >Obtener datos</button>
                    <?php echo e($value['nombre_completo']); ?> 
                    <button type="button"  class="btn btn-danger" value="enviaRestringido" onclick="datosastriskSolucionesRestringido()" id="odr">Obtener datos Restringidos</button>
                </h3> 
            ...
            <div class="panel-body">
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo e(Form::text('idr','',array('class'=>"form-control",'id'=>'idr','required' => 'required'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo e(Form::text('telefono','',array('class'=>"form-control",'id'=>'telefono','maxlength'=>'10','minlength'=>'10','required' => 'required'))); ?>

                        <div class="col-lg-1"> <a id="validatelrep" class="btn btn-warning">Validar</a> </div>
                    </div>
                </div>
                ...
                <div id='divPass' style='display: none;'>
                    <div class="form-group">
                        <?php echo e(Form::label('Contraseña','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::password('contrasena',array('class'=>"form-control",'id'=>'contra','placeholder'=>'Introdusca una contraseña valida para continuar'))); ?>
                ...
                <div id='contenido' style='display: none;'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('ap_paterno','',array('class'=>"form-control",'id'=>'ap_paterno', 'required' => 'required'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('ap_materno','',array('class'=>"form-control",'id'=>'ap_materno', 'required' => 'required'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('nombre','',array('class'=>"form-control",'id'=>'nombre', 'required' => 'required'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::date('fecnacaseg','',array('class'=>"form-control",'id'=>'fecnacaseg', 'required' => 'required'))); ?>
                    ...
                    <!-- <div class="form-group">
                        <?php echo e(Form::label('Edo. civil','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::select('edocivil', [
                                        'NOAPLICA' => 'No aplica'
                                        ],
                    ...
                    <!-- 
                     <div class="form-group">
                         <?php echo e(Form::label('Nombre conyuge','',array('class'=>"col-sm-3 control-label"))); ?>

                         <div class="col-sm-8">
                             <?php echo e(Form::text('nomconyuge','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'nombconyuge'))); ?>

                         </div>
                     </div>

                       <div class="form-group">
                         <?php echo e(Form::label('Fecha nacimiento conyuge','',array('class'=>"col-sm-3 control-label"))); ?>

                         <div class="col-sm-8">
                             <?php echo e(Form::date('fechconyuge','',array('class'=>"form-control",'id'=>'fechconyuge'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('autoriza','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'autoriza'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::select('parentesco', [
                                  ...
                                  '', ['class'=>"form-control", 'placeholder'=>"",'id'=>'parentesco', 'required' => 'required']  )); ?>
                    ...
                    <!--
                    <div class="form-group">
                        <?php echo e(Form::label('Nombre Campaña','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('orig_alta','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'orig_alta'))); ?>
                    ...
                    <!--
<div class="form-group">
<?php echo e(Form::label('Estatus Movimiento','',array('class'=>"col-sm-3 control-label"))); ?>

<div class="col-sm-8">
<?php echo e(Form::select('estatus_movimiento', [
'ESTATUS1'=>'Estatus1',
'ESTATUS2'=>'Estatus2',
'ESTATUS3'=>'Estatus3',
'ESTATUS4'=>'Estatus4',],
'', [ 'class'=>"form-control", 'placeholder'=>"",'id'=>'estatus_movimiento']  )); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::date('fecha_capt',date('Y-m-d'),array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'fecha_capt'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('direccion','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'direccion', 'required' => 'required'))); ?>
                    ...
                    <!--
                    <div class="form-group">
                        <?php echo e(Form::label('Número exterior','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('num_ext','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'num_ext'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::select('vialidad', [
                                   ...
                                   '', ['class'=>"form-control", 'placeholder'=>"",'id'=>'vialidad', 'required' => 'required']  )); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('numint','',array('class'=>"form-control", 'placeholder'=>"Escribe 0 si no tiene numero interior",'id'=>'numint'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('piso','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'piso'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::select('asentamien', [
                                          'AMPL' => 'Ampliacion',
                                          'APTO' => 'Aeropuerto',
                                          'BO'=> 'Barrio',
                                          'CAMP'=>'Campamento',
                                          ...
                                          'ZRUR'=>'Zona Rural',
                                          'ZURB'=>'Zona Urbana'],
                                      '', ['class'=>"form-control", 'placeholder'=>"",'id'=>'asentamien', 'required' => 'required']  )); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::select('state',$states->prepend(''),'',['id'=>'state','class'=>'form-control','placeholder'=>'Selecciona un estado'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::select('town',[],'',['id'=>'town','class'=>'form-control','placeholder'=>'Selecciona una delegacion o municipio'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::select('col',[],'',['id'=>'col','class'=>'form-control','placeholder'=>'Selecciona una colonia'])); ?>

                        </div>
                    </div>

                    <div class="form-group">
                        <?php echo e(Form::label('Código Postal *','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::select('cp',[],'',['id'=>'cp','class'=>'form-control','placeholder'=>'Selecciona una colonia'])); ?>

                        </div>
                    </div>

                    <div class="form-group">
                        <?php echo e(Form::label('Calle_1','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('Calle_1','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'calle1','maxlength'=>'50','minlength'=>'0'))); ?>

                        </div>
                    </div>

                    <!-- <div class="form-group">
                        <?php echo e(Form::label('Calle_2','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('Calle_2','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'calle2','maxlength'=>'50','minlength'=>'0'))); ?>

                        </div>
                    </div>

                    <div class="form-group">
                        <?php echo e(Form::label('Ref 1','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('ref_1','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'ref1','maxlength'=>'50','minlength'=>'0'))); ?>

                        </div>
                    </div>

                    <div class="form-group">
                        <?php echo e(Form::label('Ref 2','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('ref_2','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'ref2','maxlength'=>'50','minlength'=>'0'))); ?>
...
-->
                    <div class="form-group" >
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('rvtname',$value['nombre_completo'],array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'aceptaventa'))); ?>
                    ...
                    <!-- <div class="form-group" style='display:none;'>
                            <div class="col-sm-8">
                                <?php echo e(Form::text('rvt',$value['user'],array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly','id'=>'aceptaventa2'))); ?>

                            </div>
                    </div> -->

                    <div class="form-group">
                        <?php echo e(Form::label('turno','',array('class'=>"col-sm-3 control-label"))); ?>
                    ...
                    <div class="form-group">
                        <?php echo e(Form::label('Hora de inicio de la llamada de venta','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::time('hora_ini',$hora,array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly'))); ?>
                    ...
                    <!--
                    <div class="form-group">
                                                                                    <?php echo e(Form::label('Hora de fin de la llamada de venta','',array('class'=>"col-sm-3 control-label"))); ?>

                                                                                    <div class="col-sm-8">
                                                                                        <?php echo e(Form::time('hora_fin',null,array('class'=>"form-control", 'placeholder'=>""))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('num_pisos','',array('class'=>"form-control", 'placeholder'=>"No puede ser mayor al valor en el Campo Piso",'id'=>'num_pisos'))); ?>

                        </div>
                    </div>

                    <div class="form-group">
                        <?php echo e(Form::label('Cubierta','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::select('cubierta', [
                                             '1' => 'CUBIERTA PESADA',
                    ...
                    <div class="form-group">
                        <?php echo e(Form::label('Numero celular','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('num_cel','',array('class'=>"form-control",'maxlength'=>'10', 'placeholder'=>"",'id'=>'num_cel'))); ?>

                            <br>

                            <label>Compañia</label>
                            <?php echo e(Form::select('ref_1_tel', [
                                             '1' => 'TELCEL',
                                             '2' => 'IUSACELL',
                            ...
                            <?php echo e(Form::text('otra_comp_cel','',array('class'=>"form-control",'placeholder'=>"Nombre de la otra compañia telefonica",'id'=>'otra_comp_cel'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('nombre_empresa','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'nombre_empresa'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo e(Form::text('rfc','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'rfc', 'maxlength'=>'14','minlength'=>'12'))); ?>
                    ...
                    <div class="form-group">
                           ...
                           <div class="col-sm-8">
                               <?php echo e(Form::text('ref_1','',array('class'=>"form-control", 'placeholder'=>"",'id'=>'ref_2'))); ?>
...
<script type="text/javascript">
                      ...
                      $("#telefono").change(function () {
                          var url = "<?php echo e(URL('/InbursaSoluciones/buscar/venta/')); ?>" + "/" + $(this).val();
...
<script type="text/javascript">
    ...
    $("#validatelrep").click(function () {
        ...
        if (valor.length == 10) {
            ...
            $.get('/Inbursa_soluciones/venta/datos/' + $('#telefono').val() + '', function (response) {
    ...
    function datosastriskSolucionesRestringido() {
	$('#odr').hide();
        $('#od').hide();
        window.open("datosEmpresaRestringidos", "datosEmpresa", "width=600,height=800, top=100,left=100");
        return false;
        /*var url="<?php echo e(URL('/inbursaSoluciones/llamadas/datos')); ?>";
         $.get( url, function( data ) {
         $("#nombre-asterisk").val(data.nombre);
...
<script type="text/javascript">
    ...
    function ListaDes1() {
        ...
        opcion2 = new Option("Compania distinta", "Compania distinta", "defauldSelected");
        opcion3 = new Option("Numero NO comercial", "Numero NO comercial");
        opcion4 = new Option("Linea Movil", "Linea Movil");
        opcion5 = new Option("Conmutador", "Conmutador");
        opcion6 = new Option("Numero no existe", "Numero no existe");
        opcion7 = new Option("Fuera de Servicio", "Fuera de Servicio");
        opcion8 = new Option("Inviable", "Inviable");
        opcion9 = new Option("Razon social restringida", "Razon social restringida");
        opcion10 = new Option("Localidad restringidas", "Localidad restringidas");
        opcion11 = new Option("Lada restringida", "Lada restringida");
		    opcion12 = new Option("Venta", "Venta");


        
        document.forms.formulario.motivo.options[1] = opcion2;
        document.forms.formulario.motivo.options[2] = opcion3;
        document.forms.formulario.motivo.options[3] = opcion4;
        document.forms.formulario.motivo.options[4] = opcion5;
        document.forms.formulario.motivo.options[5] = opcion6;
        document.forms.formulario.motivo.options[6] = opcion7;
        document.forms.formulario.motivo.options[7] = opcion8;
        document.forms.formulario.motivo.options[8] = opcion9;
        document.forms.formulario.motivo.options[9] = opcion10;
        document.forms.formulario.motivo.options[10] = opcion11;
		    document.forms.formulario.motivo.options[11] = opcion12;
    }
    ...
    function ListaDes2() {
        ...
        opcion3 = new Option("Ya cuenta con el servicio", "Ya cuenta con el servicio");
        opcion4 = new Option("Reagenda", "Reagenda");
