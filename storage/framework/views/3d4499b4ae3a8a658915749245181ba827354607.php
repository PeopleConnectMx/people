    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <?php echo e(Form::open(['action' => 'VivaAnunciosController@wibeGuarda',
                              'method' => 'post',
                ...
                <div id='contenido'>
                    ...
                    <div class="form-group">
                        <?php echo e(Form::label('genero','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('genero','',array('class'=>"form-control",'id'=>'genero'))); ?>
                    ...
                    <div class="form-group">
                        <?php echo e(Form::label('Observaciones','',array('class'=>"col-sm-3 control-label"))); ?>

                        <div class="col-sm-8">
                            <?php echo e(Form::text('observaciones','',array('class'=>"form-control",'id'=>'observaciones'))); ?>
