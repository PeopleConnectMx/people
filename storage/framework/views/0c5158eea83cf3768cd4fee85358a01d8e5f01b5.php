...
<html lang="es">
    <head>
        ...
        <script src="<?php echo e(asset('assets/js/val.js')); ?>"></script>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo e(url('/inbursa/validacion')); ?>">Buscar folio</a></li>
                                <li><a href="<?php echo e(url('/InbursaVidatel/validacion')); ?>">Buscar folio Vidatel</a></li>
