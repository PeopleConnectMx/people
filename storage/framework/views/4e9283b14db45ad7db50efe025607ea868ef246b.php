        ...
        <table class="table table-bordered">
          ...
          <?php foreach($users as $key => $userValue): ?>
            <tr>
              ...
              <td>
                <?php echo e(Form::text("user$key",$userValue->asistencia,array('class'=>"form-control",'id'=>'total', 'readonly'=>'readonly'))); ?>

              </td>
              <td>
              <?php echo e(Form::text("user$key",$userValue->motivo_falta,array('class'=>"form-control",'id'=>'total', 'readonly'=>'readonly'))); ?>

              </td>
              <td>
                <?php echo e(Form::text("observaciones$key",$userValue->observaciones,array('class'=>"form-control", 'readonly'=>'readonly'))); ?>
...
<?php echo $__env->make('layout.tmpre.super.inicio', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>