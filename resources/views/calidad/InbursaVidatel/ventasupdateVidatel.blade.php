    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(['action' => 'CalidadController@updateVentasVidatel',
                                'method' => 'post',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         {{ Form::date('fechaVenta',$datos[0]->fecha_venta,array('class'=>"form-control", 'placeholder'=>"********")) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      '1' => 'Si',
                      '0' => 'No'],
                      $datos[0]->script, ['required' => 'required', 'class'=>"form-control", 'placeholder'=>""]  ) }}
                    </div>
                </div>
