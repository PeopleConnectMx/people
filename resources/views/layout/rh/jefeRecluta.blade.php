                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('rh/citasPersonal') }}">Citas Agendadas Personal</a></li>
                                ...
                                <li><a href="{{ url('rh/asistencia') }}">Asistenacia</a></li>
                                ...
                                <li><a href="{{ url('/subirCancelaciones') }}">Subir reporte de cancelaciones</a></li>
                                <li><a href="{{ url('/cancelaciones') }}">Reporte de cancelaciones </a></li>
