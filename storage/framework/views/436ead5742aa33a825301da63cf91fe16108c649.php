    ...
    <div class="">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"> Numero Asignados Facebook Chat: <?php echo e(session('user')); ?> <?php echo e(session('nombre')); ?> </h3>
            </div>
            <div class="panel-body">
                ...
                <?php foreach($datos as $value): ?>
                    <form method="POST" action="<?php echo e(url('guardaCambiosChat')); ?>" name="formulario">
                        <tbody>
                                <?php if($value->estatus_chat_res == "Venta" || $value->estatus_chat_res == "CAC Lejano" || $value->estatus_chat_res == "Linea Inactiva" || $value->estatus_operador == "Venta" || $value->estatus_operador == "CAC Lejano" || $value->estatus_operador == "Linea Inactiva" || $value->estatus_operador == "Movistar" ): ?>
                                    ...
                                    <tr>
                                        <td style="display: none;">
                                         ...
                                         <td>
                                            <div class="form-group">
                                                <div class="">
                                                    <?php echo e(Form::text('nombreChat', $value->usuariochat, ['class'=>"form-control", 'placeholder'=>"", 'readonly'=>"readonly"]  )); ?>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="">
                                                    <?php echo e(Form::text('telefono', $value->dn, ['class'=>"form-control", 'placeholder'=>"", 'maxlength'=>"10", 'readonly'=>"readonly"]  )); ?>
                                        ...
                                        <td> 
                                            ...
                                            <div style='display: none;' id='reagenda'>
                                                <div class="form-group">
                                                    <?php echo e(Form::label('Fecha Agenda','',array('class'=>"control-label"))); ?>

                                                    <?php echo e(Form::date('fechaAgenda','',array('class'=>"form-control", "id"=>"fechaAgenda"))); ?>

                                                </div>
                                                <div class="form-group">
                                                    <?php echo e(Form::label('Hora Agenda','',array('class'=>"control-label"))); ?>

                                                    <?php echo e(Form::time('horaAgenda','',array('class'=>"form-control", "id"=>"horaAgenda"))); ?>
                                        ...
                                        <td> 
                                            <div class="form-group">
                                                <div class="">
                                                    <?php echo e(Form::text('fechaAge', $value->fecha_agenda,['class'=>"form-control", 'placeholder'=>""]  )); ?>


                                                    <?php echo e(Form::time('tiem', $value->hora_agenda,['class'=>"form-control", 'placeholder'=>""]  )); ?>
                                        ...
                                        <td> 
                                            <div class="form-group">
                                                <div class="">
                                                    <?php echo e(Form::text('fecha', $value->fecha, ['class'=>"form-control", 'placeholder'=>"", 'readonly'=>"readonly"]  )); ?>
                                        ...
                                        <td> 
                                            <div class="form-group">
                                                <div class="">
                                                    <?php echo e(Form::text('fecha', $value->updated_at, ['class'=>"form-control", 'placeholder'=>"", 'readonly'=>"readonly"]  )); ?>
