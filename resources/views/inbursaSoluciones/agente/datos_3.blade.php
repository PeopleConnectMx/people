              ...
              {{ Form::open(['action' => 'InbursaSolucionesController@FromularioInbSoluciones',
                              ...
                              'onsubmit'=>'return validar()'
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {{ Form::text('id',$datos[0]->id,array('class'=>"form-control")) }}
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    {{ Form::label('Telefono1 asd','',array('class'=>"col-sm-3 control-label")) }}
                                    <div class="col-sm-8">
                                        {{ Form::text('telefono',$datos[0]->tel1,array('class'=>"form-control")) }}
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    {{ Form::label('Telefono2','',array('class'=>"col-sm-3 control-label")) }}
                                    <div class="col-sm-8">
                                        {{ Form::text('telefono',$datos[0]->tel2,array('class'=>"form-control")) }}
                                    </div>
                                </div>

                                <div class="form-group">
                                    {{ Form::label('Telefono3','',array('class'=>"col-sm-3 control-label")) }}
                                    <div class="col-sm-8">
                                        {{ Form::text('telefono',$datos[0]->tel3,array('class'=>"form-control")) }}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    {{ Form::label('correo','',array('class'=>"col-sm-3 control-label")) }}
                                    <div class="col-sm-8">
                                        {{ Form::text('telefono',$datos[0]->correo,array('class'=>"form-control")) }}
                                    </div>
                                </div>
