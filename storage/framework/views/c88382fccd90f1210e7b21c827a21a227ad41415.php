        ...
        <header>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Gerente de RH</a>
                </div>
...
<!--                              <li><a href="<?php echo e(url('/Administracion/root')); ?>">Nuevo empleado</a></li>       -->
                                ...
                                <li><a href="<?php echo e(url('/recepciontotal')); ?>">Listado</a></li>
                                <li><a href="<?php echo e(url('Administracion/admin/plantilla')); ?>">Plantilla</a></li>
                                <li><a href="<?php echo e(url('/rh/nuevo/candidato')); ?>">Nuevo Empleado</a></li>
...
<!--                                 <li><a href="<?php echo e(url('/Administracion/personal')); ?>">Personal</a></li> -->
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo e(url('rh/nuevo/candidato')); ?>">Nuevo Candidato</a></li>
                                <li><a href="<?php echo e(url('rh/candidatosCaptura')); ?>">Listado</a></li>
                                <li><a href="<?php echo e(url('/perCandEntre')); ?>">Citas no atendidas</a></li>
                            </ul>
                        </li>
