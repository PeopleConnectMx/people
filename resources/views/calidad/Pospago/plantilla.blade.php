                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  ...
                                  @foreach($datosArray as $key => $value)
                                    <tr>
                                        <td> <a href="{{ url('calidad/pospago/ventas/reporte/'.$value['id'].'/'.$fecha_i.'/'.$fecha_f) }}">{{$value['nombre']}}</a></td>
                                        ...
                                        @foreach($fechaValue as $valueFecha)
                                          ...
                                          @if( $value['calidad'.$valueFecha]==="--" )
                                            <td>--</td>
                                          @else
                                            <td><a href="{{url('calidad/pospago/ventas/NumMon/'.$value['id'].'/'.$valueFecha) }}">{{$value['calidad'.$valueFecha]}}</a></td>
                                          @endif
