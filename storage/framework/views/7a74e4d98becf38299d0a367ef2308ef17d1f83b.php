          ...
          <div class="row">
            <h3 class="col-lg-2">
              ...
              <select class="form-control" id="select" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                <option value="<?php echo e(URL('/direccion/proyeccion/pospago')); ?>/<?php echo e(date('Y-m-d')); ?>"></option>
                <?php foreach($rfechas as $value): ?>
                <option value="<?php echo e(URL('/direccion/proyeccion/pospago')); ?>/<?php echo e($value->a); ?>-<?php echo e($value->m); ?>-<?php echo e(date('d')); ?>"><?php echo e($value->a); ?>-<?php echo e($value->m); ?></option>
                <?php endforeach; ?>
              </select>
                ...
                <tr class="success">
                  ...
                  <tr class="success">
                    ...
                    <?php /**/
                      ...
                      <?php /**/ $altasm= array_key_exists($date, $altas_prepago_m) ? $altas_prepago_m[$date] : 0 /**/ ?>
                      <?php /**/ $num_altasm= array_key_exists($date, $num_altas_prepago_m) ? $num_altas_prepago_m[$date] : 0 /**/ ?>
                      <?php /**/ $color='black'; $calc=0;
                      if($dias!=0){
                        $calc= round(($altasm/$dias)*100 ,0);
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="number" id="tmprealtm<?php echo e($date); ?>" onchange="tmprealtgen(this.id)" value="<?php echo e($dias); ?>"  style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtm<?php echo e($date); ?>2" >
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($num_altasm); ?> </span>
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($altasm); ?>% </span>
                        </div>
                      </td>
                      <?php /**/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /**/ ?>
                    ...
                    <td>
                        <div>
                          <span> <?php echo e(round($tot1/$contador,2)); ?> %</span><br>
                          <span class="badge" style="background-color:<?php echo e($color); ?>;"><?php echo e($tot3); ?> </span>
                          <span class="badge" style="background-color:<?php echo e($color); ?>;"><?php echo e(round($tot2/$contador,2)); ?>% </span>
                        </div>
                    </td>
                  </tr>
                  ...
                  <tr class="success">
                    ...
                    <?php /**/
                        $dias=40;
                      /**/ ?>
                      <?php /**/ $altasv= array_key_exists($date, $altas_prepago_v) ? $altas_prepago_v[$date] : 0 /**/ ?>
                      <?php /**/ $num_altasv= array_key_exists($date, $num_altas_prepago_v) ? $num_altas_prepago_v[$date] : 0 /**/ ?>
                      <?php /**/ $color='black'; $calc=0;
                      if($dias!=0){
                        $calc= round(($altasv/$dias)*100 ,0);
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="number" id="tmprealtv<?php echo e($date); ?>" value="<?php echo e($dias); ?>"  onchange="tmprealtgen(this.id)" style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtv<?php echo e($date); ?>2" >
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($num_altasv); ?></span>
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($altasv); ?>% </span>
                        </div>
                      </td>
                      <?php /**/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /**/ ?>
                  ...
                  <tr class="success">
                    ...
                    <?php /**/
                      ...
                      <?php /**/ $num_altasm_pos= array_key_exists($date, $num_altas_pospago_m) ? $num_altas_pospago_m[$date] : 0 /**/ ?>
                      <?php /**/ $num_altasv_pos= array_key_exists($date, $num_altas_pospago_v) ? $num_altas_pospago_v[$date] : 0 /**/ ?>

                      <?php /**/ $altas_totales= $num_altasm + $num_altasv + $num_altasm_pos + $num_altasv_pos /**/ ?>
                      <?php /**/ $altas_totales_pre= $num_altasm + $num_altasv /**/ ?>
                      <?php /**/ $altas_totales_pos= $num_altasm_pos + $num_altasv_pos /**/ ?>
                      <?php /**/
                        $altas_totales != 0 ?
                        $altas_prepago_calc= round( ($altas_totales_pre / $altas_totales) * 100 , 0)
                        :
                        $altas_prepago_calc=0;
                        /**/ ?>
                      <?php /**/
                        $altas_totales != 0 ?
                        $altas_pospago_calc= round( ($altas_totales_pos / $altas_totales) * 100 , 0)
                        :
                        $altas_pospago_calc=0;
                        /**/ ?>
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="text" id="tmprealtg<?php echo e($date); ?>" value="<?php echo e($dias); ?>"  style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtg<?php echo e($date); ?>2" >
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($num_altasm + $num_altasv); ?> </span>
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($altas_prepago_calc); ?>% </span>
                        </div>
                      </td>
                      <?php /**/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /**/ ?>
                    <?php endwhile; ?>
                    ...
                    <td>
                        <div>
                          <span> <?php echo e(round($tot1/$contador,2)); ?> %</span><br>
                          <span class="badge" style="background-color:<?php echo e($color); ?>;"><?php echo e($tot3); ?> </span>
                          <span class="badge" style="background-color:<?php echo e($color); ?>;"><?php echo e($tot4 !=0 ? round(($tot3/$tot4)*100,2) : 0); ?>% </span>
                        </div>
                    </td>
                  </tr>
                  ...
                  <tr class="warning">
                    ...
                    <?php /**/
                      ...
                      <?php /**/ $altasm= array_key_exists($date, $altas_pospago_m) ? $altas_pospago_m[$date] : 0 /**/ ?>
                      <?php /**/ $num_altasm= array_key_exists($date, $num_altas_pospago_m) ? $num_altas_pospago_m[$date] : 0 /**/ ?>
                      <?php /**/ $color='black'; $calc=0;
                      if($dias!=0){
                        $calc= round(($altasm/$dias)*100 ,0);
                  ...
                  <tr class="warning">
                    ...
                    <?php /**/
                        $dias=60;
                      /**/ ?>
                      <?php /**/ $altasv= array_key_exists($date, $altas_pospago_v) ? $altas_pospago_v[$date] : 0 /**/ ?>
                      <?php /**/ $num_altasv= array_key_exists($date, $num_altas_pospago_v) ? $num_altas_pospago_v[$date] : 0 /**/ ?>
                  ...
                  <tr class="warning">
                    ...
                    <?php /**/
                      ...
                      if($dias!=0){
                        ...
                        $tot1 += $dias;
                        $tot2 += $altas;
                        $tot3 += $num_altasm_pos+ $num_altasv_pos;
                        $tot4 += $altas_totales;
                      ...
                      <td style="text-align: center;">
                        ...
                        <input type="text" id="tmprealtg<?php echo e($date); ?>" value="<?php echo e($dias); ?>"  style="width: 23px; margin-left: -20%; background-color:transparent; border-color:transparent; text-align: right;">%
                        <div id="tmprealtg<?php echo e($date); ?>2" >
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($num_altasm_pos+ $num_altasv_pos); ?> </span>
                          <span class="badge" style="margin-left: -20%;background-color:<?php echo e($color); ?>;"><?php echo e($altas_pospago_calc); ?>% </span>
                        </div>
                      </td>
                      <?php /**/ $date = date ("Y-m-d", strtotime("+1 day", strtotime($date))) /**/ ?>
                    <?php endwhile; ?>
...
function tmpreposgen(id) {
  ...
  act(fecha,"tmpos","pos",parseInt($(idmat).val()),"m");
  act(fecha,"tmpos","pos",parseInt($(idves).val()),"v");
  act(fecha,"tmpos","pos",val,"g");
  $(idgen).val( val );
  ...
  act(fecha,"tmpos","ven",parseInt($(idvenmat).val()),"m");
  act(fecha,"tmpos","ven",parseInt($(idvenves).val()),"v");
  act(fecha,"tmpos","ven",parseInt($(idvengen).val()),"g");
...
function tmprevphgen(id) {
  ...
  $(idgen).val( val );
  act(fecha,"tmpos","vph",$(idmat).val(),"m");
  act(fecha,"tmpos","vph",$(idves).val(),"v");
  act(fecha,"tmpos","vph",$(idgen).val(),"g");
  ...
  act(fecha,"tmpos","numalt",parseInt($(idaltasnum_m).val()),"m");
  act(fecha,"tmpos","numalt",parseInt($(idaltasnum_v).val()),"v");
  act(fecha,"tmpos","numalt",parseInt($(idaltasnum_g).val()),"g");
...
function tmprevengen(id) {
  ...
  act(fecha,"tmpos","ven",parseInt($(idmat).val()),"m");
  act(fecha,"tmpos","ven",parseInt($(idves).val()),"v");
  act(fecha,"tmpos","ven",val,"g");
  $(idgen).val( val );
}
...
function tmprerechgen(id) {
  ...
  act(fecha,"tmpos","rech",parseFloat($(idmat).val()),"m");
  act(fecha,"tmpos","rech",parseFloat($(idves).val()),"v");
  act(fecha,"tmpos","rech",val,"g");
  /*---------- Guarda valores rechazos finales ---------*/
  act(fecha,"tmpos","rfin",valm,"m");
  act(fecha,"tmpos","rfin",valv,"v");
...
function tmprerecugen(id) {
  ...
  act(fecha,"tmpos","recu",parseFloat($(idmat).val()),"m");
  act(fecha,"tmpos","recu",parseFloat($(idves).val()),"v");
  act(fecha,"tmpos","recu",val,"g");
...
function tmprerfingen(id) {
  ...
  act(fecha,"tmpos","rfin",parseInt($(idmat).val()),"m");
  act(fecha,"tmpos","rfin",parseInt($(idves).val()),"v");
  act(fecha,"tmpos","rfin",val,"g");
  $(idgen).val( val );
}
...
function tmpreinggen(id) {
  ...
  var val= (parseInt($(idmat).val()) + parseInt($(idves).val())) /2 ;
  act(fecha,"tmpos","ing",parseInt($(idmat).val()),"m");
  act(fecha,"tmpos","ing",parseInt($(idves).val()),"v");
  act(fecha,"tmpos","ing",val,"g");
  $(idgen).val( val );
}
...
function tmprealtgen(id) {
  ...
  var val= parseInt($(idmat).val()) + parseInt($(idves).val());
  act(fecha,"tmpos","alt",parseInt($(idmat).val()),"m");
  act(fecha,"tmpos","alt",parseInt($(idves).val()),"v");
  act(fecha,"tmpos","alt",val,"g");
  $(idgen).val( val );
}
