    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              {{ Form::open(['action' => 'BoBanamexController@BoRecuperacion',
                              'method' => 'post',
              ...
              <div class="form-group"  align='Center'>
                  ...
                  <div class="col-sm-4">
                        {{ Form::text('tel',$datos[0]->dn,array('class'=>"form-control",  'placeholder'=>"",'readonly'=>'readonly','id'=>'nombre')) }}
                  </div>
				  {{ Form::label('No. de Venta','',array('class'=>"col-sm-1 control-label")) }}
				  <div class="col-sm-4">
                        {{ Form::text('venta',$datos[0]->v_id,array('class'=>"form-control",  'placeholder'=>"",'readonly'=>'readonly','id'=>'nombre')) }}
                  </div>
              </div>
                ...
                <div id="exist"> <!-- si encuentra dn -->
                  ...
                  <div id="cos"> <!--Cliente_objetivo Si  -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          {{ Form::date('fecha_cumple', $datos[0]->fecha_nacimiento,array('class'=>"form-control", 'placeholder'=>"********")) }}
                        </div>
                    </div>
					...
					<div class="form-group" style='display: none;' id='ventaAutenticada'>
					 ...
					 <div class="form-group" style='display: none;' id='folio'>
						...
						<div class="col-md-10">
							{{ Form::text('Folio Banamex',$datos[0]->folio,array('class'=>"form-control", 'required' => 'required', 'id'=>'foliof' )) }}
						</div>
					</div>
