    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                {{ Form::open(['action' => 'RhController@Back',
                                'method' => 'post',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nom_emergencia1','',array('class'=>"form-control", 'placeholder'=>"Nombre del Contacto Emergencia 1")) }}
                        {{ Form::number('emergencia1','',array('class'=>"form-control", 'placeholder'=>"Telefono 1")) }}
                        {{ Form::text('nom_emergencia2','',array('class'=>"form-control", 'placeholder'=>"Nombre del Contacto Emergencia 2")) }}
                        {{ Form::number('emergencia2','',array('class'=>"form-control", 'placeholder'=>"Telefono 2")) }}
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->turno,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Fecha de entrevista ','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',date("Y-m-d", strtotime($user[0]->fecha_cita)),array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->sucursal,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',date("H:i:s", strtotime($user[0]->fecha_cita)),array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->reclutador,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->area,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Puesto','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->puesto,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Teléfono','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->telefono_fijo,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                   {{ Form::label('Celular','',array('class'=>"col-sm-2 control-label")) }}
                   <div class="col-sm-10">
                       {{ Form::text('nombre',$user[0]->telefono_cel,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                   </div>
               </div>
                <div class="form-group">
                    {{ Form::label('Email','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->email,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Campaña','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                         {{ Form::text('nombre',$user[0]->campaign,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
               <div class="form-group">
                    {{ Form::label('Experiencia','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->experiencia,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->estatus_llamada,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->tipo_medio_reclutamiento,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->medio_reclutamiento,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->estatus_cita,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Fecha de Nacimiento','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->fecha_nacimiento,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Sexo','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->sexo,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Estado civil','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->estado_civil,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         {{ Form::text('nombre',$user[0]->estado,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         {{ Form::text('nombre',$user[0]->delegacion,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Colonia','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                         {{ Form::text('nombre',$user[0]->colonia,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         {{ Form::text('street',$user[0]->calle,array('class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                ...
                <div class="form-group" id="hijo">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->hijos,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->s_base,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Sueldo complemento','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->s_complemento,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Bono Asistencia y Puntualidad','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->bono_asis_punt,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Bono Calidad','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->bono_calidad,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Bono Productividad','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->bono_productividad,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Resultado de cita *','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->resultado_cita,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Fecha  de Capacitación *','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->fecha_capacitacion,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Nombre de Capacitor ','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->nombre_capacitador,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('Estado de Capacitación *','',array('class'=>"col-sm-2 control-label")) }}
                    <div class="col-sm-10">
                        {{ Form::text('nombre',$user[0]->estado_capacitacion,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'readonly'=>'readonly')) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        {{ Form::submit('Salir',['class'=>"btn btn-default"]) }}
                    </div>
                </div>
                {{ Form::close() }}
