    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php echo e(Form::open(['action' => 'RhController@NuevoCandidatoCaptura',
                                'method' => 'post',
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <?php echo e(Form::submit('Enviar',['class'=>"btn btn-primary",'onClick'=>'return confirm("seguro que desea guardar la información"),ValTel()'])); ?>
