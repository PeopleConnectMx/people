                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="{{ url('/auri/graficaLlamada') }}" class="btn btn-link" title="Grafica Llamadas" >
                                    <span class="glyphicon glyphicon-signal" aria-hidden="true"></span>
                                </a>
                            </li>
                            <li><a href="{{ url('/auri/reporteLlamada') }}" class="btn btn-link" title="Reporte Llamadas" >
                            ...
                            <li><a href="{{ url('salir') }}" class="btn btn-link" title="Cerrar sesión" >
