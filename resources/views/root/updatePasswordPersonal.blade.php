    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(['action' => 'RootController@UpPasswordPersonal',
                                'method' => 'post',
                ...
                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                        {{ Form::text('supervisorid',$sup,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group" style="display: none">
                    <div class="col-sm-10">
                        {{ Form::text('areaid',$area,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"", 'readonly'=>'readonly')) }}
                    </div>
                </div>
                <div class="form-group">
