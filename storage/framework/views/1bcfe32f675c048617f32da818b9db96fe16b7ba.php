    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Reportes Banamex</h3>
            </div>
            <div class="panel-body">

                <?php echo e(Form::open(['action' => 'BanamexController@ReporteSend',
                                'method' => 'post',
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Tipo reporte','',array('class'=>"col-sm-2 control-label"))); ?>

                    <div class="col-sm-10">
                      <?php echo e(Form::select('rep', [
                      'tipificacion' => 'Tipificacion',
                      'nuevosClientes' => 'Nuevos Clientes',
                      'ventas' => 'Ventas',
                      'nuevosDatos' => 'Nuevos Datos',
                      'ventas2'=>'Ventas2'],
