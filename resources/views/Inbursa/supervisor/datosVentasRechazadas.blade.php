...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            ...
            {{ Form::open(['action' => 'SupervisorController@actualizaDatos',
                                'method' => 'post',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::text('paterno',$datos[0]->paterno,array('required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'paterno')) }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{ Form::date('fechaNacimiento',date("Y-m-d", strtotime($datos[0]->fecha_nac)),array('class'=>"form-control", 'placeholder'=>"********",'id'=>'fechaNacimiento')) }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        'M' => 'Masculino',
                        'F' => 'Femenino'],
                    $datos[0]->genero, ['required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'sexo']  ) }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        'ZRUR'=>'ZRUR',
                        'ZURB'=>'ZURB'],
                    $datos[0]->asentamiento, ['required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'asentamiento']  ) }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        'RIO'=>'RIO',
                        'NGN'=>'NGN'],
                    $datos[0]->tipo_fuente, ['required' => 'required', 'class'=>"form-control", 'placeholder'=>"",'id'=>'tipofuente']  ) }}
                    </div>
