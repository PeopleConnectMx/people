                        ...
                        <table border="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo e(Form::label('ab', $valores[0]->nombre_completo,array('class'=>"col-sm-10 control-label"))); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(Form::label('N° de empleado: ','',array('class'=>"col-sm-2 control-label"))); ?></td>
                                    <td><?php echo e(Form::label('ab',$valores[0]->quien_solicita,array('class'=>"col-sm-8 control-label"))); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(Form::label('Area: ','',array('class'=>"col-sm-2 control-label"))); ?></td>
                                    <td><?php echo e(Form::label('ab',$valores[0]->area,array('class'=>"col-sm-8 control-label"))); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(Form::label('Puesto: ','',array('class'=>"col-sm-2 control-label"))); ?></td>
                                    <td><?php echo e(Form::label('ab',$valores[0]->puesto,array('class'=>"col-sm-8 control-label"))); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(Form::label('Campaña: ','',array('class'=>"col-sm-2 control-label"))); ?></td>
                                    <td><?php echo e(Form::label('ab',$valores[0]->campaign,array('class'=>"col-sm-8 control-label"))); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table border="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo e(Form::label('ab',$valores[0]->titulo,array('class'=>"col-sm-10 control-label"))); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(Form::label('Divicion: ','',array('class'=>"col-sm-2 control-label"))); ?></td>
                                    <td><?php echo e(Form::label('ab',$valores[0]->divicion,array('class'=>"col-sm-8 control-label"))); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(Form::label('Descripcion: ','',array('class'=>"col-sm-2 control-label"))); ?></td>
                                    <td><?php echo e(Form::label('ab',$valores[0]->descripcion,array('class'=>"col-sm-8 control-label"))); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(Form::label('Fecha/hora: ','',array('class'=>"col-sm-2 control-label"))); ?></td>
                                    <td><?php echo e(Form::label('ab',$valores[0]->hora_envio,array('class'=>"col-sm-8 control-label"))); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
