...
<div class="alert alert-dismissible alert-danger">
  ...
  <strong>
    <h2>
      <a href="{{URL('/Inbursa_Soluciones/Calidad/Audios/Inicio')}}" class="alert-link">Volver</a>
    </h2>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    {{ Form::open(['action' => 'V2\Inbursa\CalidadController@CalidadAudiosGuardarSoluciones',
                    'method' => 'post',
      ...
      <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
              {{ Form::text('campania','Inbursa Soluciones',
