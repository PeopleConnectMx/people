    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <?php echo e(Form::open(['action' => 'BoController@BoMarcacionDatos2',
                              'method' => 'post',
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Fecha Venta Inicio','',array('class'=>"col-sm-2 control-label"))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('Fecha Venta Fin','',array('class'=>"col-sm-2 control-label"))); ?>
