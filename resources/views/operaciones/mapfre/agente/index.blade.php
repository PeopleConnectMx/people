            ...
            <div class="panel-body">
                ...
                <div style="display:none;" id="newAddress">
                  <div class="form-group">
                      {{ Form::label('Estado *','',array('class'=>"col-sm-2 control-label")) }}
                      <div class="col-sm-9">
                           {{Form::select('state',$states->prepend(''),'',['required'=>'required','id'=>'state','class'=>'form-control','placeholder'=>'Selecciona un estado'])}}
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                           {{Form::select('town',[],'',['required'=>'required','id'=>'town','class'=>'form-control','placeholder'=>'Selecciona una delegacion o municipio'])}}
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                           {{Form::select('col',[],'',['required'=>'required','id'=>'col','class'=>'form-control','placeholder'=>'Selecciona una colonia'])}}
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                           {{Form::select('cp',[],'',['required'=>'required','id'=>'cp','class'=>'form-control','placeholder'=>'Selecciona una colonia'])}}
                      </div>
                  </div>
...
$("#telefonoset_home").click(function(event) {
  ...
  var num = $("#homePhone").val();
  //var num = num.substr(num.length - 8);
  // console.log(num);
  var lada = num.substring(0, 2);
  if(lada=='55'){
...
$("#telefonoset_new").click(function(event) {
  var ext = "<?php echo session('extension'); ?>";
  var num = $("#newNumber").val();
  var tiponum = $("#tipoNewNumber").val();
  var lon = num.length;

  if((tiponum==3 || tiponum==4) && lon == 10) {
    var lada = num.substring(0, 2);
    // if(lada=='55'){
    //   num='044' + num + '';
    // }
  ...
  else if ((tiponum==1 || tiponum==2) && lon == 10) {
    var lada = num.substring(0, 2);
    if(lada=='55'){
      num=num.substr(num.length - 8);
    }
    ...
    num=0;
    alert('No se puede marcar el número');
  }
  //var num = num.substr(num.length - 8);
  // console.log(num);
  if (num!=0){
